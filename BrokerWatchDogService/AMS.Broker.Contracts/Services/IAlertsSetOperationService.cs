...
namespace AMS.Broker.Contracts.Services
{
    ...
    public interface IAlertsSetOperationService
    {
        ...
        [OperationContract]
        bool CancelAlertsByMail(string AlertId, string authToken, string AlertCloseReason);
        ...
        [OperationContract]
        bool AddFcmToken(string FCMToken, string DeviceId);

        [OperationContract]
        bool DeleteMedia(string FileName);

        #region Thinclient 03032020
        [OperationContract]
        bool CloseAlertsForThinClient(string alertId, string authToken, int CloseReasonID);
