...
namespace AMS.Broker.Contracts.DTO
{
    ...
    public class SiteDto
    {
        ...
        [DataMember]
        public int EmContactId1 { get; set; }

        [DataMember]
        public int EmContactId2 { get; set; }

        [DataMember]
        public int EmContactId3 { get; set; }

        [DataMember]
        public int EmContactId4 { get; set; }

        [DataMember]
        public int EmContactId5 { get; set; }

        [DataMember]
        public int EmContactId6 { get; set; }

        [DataMember]
        public int EmContactId7 { get; set; }

        [DataMember]
        public int EmContactId8 { get; set; }

        [DataMember]
        public int EmContactId9 { get; set; }

        [DataMember]
        public int EmContactId10 { get; set; }
