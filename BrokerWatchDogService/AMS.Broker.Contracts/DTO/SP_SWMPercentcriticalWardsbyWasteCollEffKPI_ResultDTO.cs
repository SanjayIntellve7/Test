...
{
    [DataContract()]
    public partial class SP_SWMPercentcriticalWardsbyWasteCollEffKPI_ResultDTO
    {
        [DataMember()]
        ...
        [DataMember()]
        public Nullable<DateTime> Cleandatetime { get; set; }

        [DataMember()]
        public Nullable<Int32> FilledLevelStatus { get; set; }
        ...
        public SP_SWMPercentcriticalWardsbyWasteCollEffKPI_ResultDTO()
        {
        }

        public SP_SWMPercentcriticalWardsbyWasteCollEffKPI_ResultDTO(Int32 iD, String binID, String rFID, String binType, String binColor, Nullable<Double> capacity, String wardNo, String binAddress, Nullable<DateTime> cleandatetime, Nullable<Int32> filledLevelStatus, Nullable<Int32> filledLevel, Nullable<Int32> thresholdlimit, String filledLevelStatusLabel, String filledLevelStatusColour)
        {
            this.ID = iD;
            this.BinID = binID;
            this.RFID = rFID;
