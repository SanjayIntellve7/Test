...
{
    [DataContract()]
    public partial class SP_ITMSViolationKPI_ResultDTO
    {
        [DataMember()]
        ...
        public SP_ITMSViolationKPI_ResultDTO()
        {
        }

        public SP_ITMSViolationKPI_ResultDTO(Int32 iD, String violationName, String violationCatgId, String violationCatgName, String violationId, String eqpId, String eqpId2, String imgPath, String imageFileName, String vidPath, String npColor, String npText, String violationTime, String eqpCatgId, String eqpCatgName, String eqpTypeId, String eqpTypeName, String status, String regionId, String regionName, String zoneId, String zoneName, String wardId, String wardName, String junctionId, String junctionName, String lat, String long_, String directionId, String directionName, Nullable<Int64> alertId, String imageFileName1)
        {
            this.ID = iD;
