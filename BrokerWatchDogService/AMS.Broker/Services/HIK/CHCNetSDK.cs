...
namespace AMS.Broker.Services.HIK
{
    ...
    public class CHCNetSDK
    {
        ...
        //yog
        [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
        public struct NET_DVR_ALARMINFO_FIXED_HEADER
        {
            public uint dwAlarmType;              /*0- sensor alarm; 1- hard disk full; 2- video lost; 3- motion detection; 4- hard disk unformatted; 5- hard disk error; 6- tampering detection; 7- unmatched video output standard; 8- illegal operation; 9- video exception; 0xa- record exception 
                        11- Vca scene change 12-Array exception 13 resolution dismatch,14-alloc decode resource fail,15-VCA detect*/
            public NET_DVR_TIME_EX struAlarmTime;	//alarm Time
        }
        //
        [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
        ...
        {
            public uint dwSize; 						//Structure length
            public uint dwRelativeTime; 				//relative time stamp
            public uint dwAbsTime; 					//Absolute time stamp
            NET_VCA_RULE_INFO struRuleInfo; 	//Event rule info
            NET_VCA_TARGET_INFO struTargetInfo; 	//Alarm target info
            public NET_VCA_DEV_INFO struDevInfo; 		//PU device info
        
            public uint  dwPicDataLen; 	//Return snapshot length, 0- no snapshot;  others- snapshot data size followed*/
        /* public byte  byPicType;	//0- normal picture, 1- contrast picture
         public byte  byRelAlarmPicNum; //Related alarm picture number
         public byte  bySmart;   //IDS DEV Return 0(default)£¬Smart Functiom Return 1
         public byte  byRes;		//Reserved
         public uint  dwAlarmID; //Alarm ID,marking the same group of alarmls£¬0-unused
         [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
         public byte[] byRes;
        ...
        {
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_PlATE_NO_LEN)]
            public string sPlateNo;
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_PlATE_NO_LEN)]
            public string sParkIndex;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LENPARK, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        [StructLayoutAttribute(LayoutKind.Sequential)]
        ...
        public struct NET_DVR_CROSSLINE_ALARM
        {
            ...
            public NET_DVR_TIME_EX struTriggerTime;/*Trigger Time*/
            public NET_DVR_PARK_INFO struParkInfo; //Parking Information           
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] byRes1;
        }
        //
        ...
        public const int MAX_PlATE_NO_LEN = 32;   //Max Plate Number Len 2013-09-27
        public const int NAME_LEN = 32;
        public const int NAME_LENPARK = 64;
        ...
        [DllImport("HCNetSDK.dll")]
        public static extern string NET_DVR_GetErrorMsg(ref Int32 pErrorNo);
        ...
        //[DllImport("HCNetSDK.dll")]
        //public static extern int  NET_DVR_GetFileByTime(int lUserID,int lChannel, ref NET_DVR_TIME lpStartTime, ref NET_DVR_TIME lpStopTime, char *sSavedFileName);
        ...
        [DllImport("HCNetSDK.dll")]
        public static extern int NET_DVR_SetupAlarmChan_V41(int lUserID, tagNET_DVR_SETUPALARM_PARAM lpSetupParam);
        ...
        public struct tagNET_DVR_SETUPALARM_PARAM
        {
            ...
            public byte bySupport; //Bit0- Two level of Alarm Upload Picture: 0-Upload£¬1-Do not upload
            public byte byBrokenNetHttp;//Resume broken network  ( bit0- license plate detection (IPC) )
        ...
        public struct tagNET_VCA_RULE_INFO
        {
            ...
            /* public byte byRuleID;
             ...
             public byte[] byRes;
             public ushort   wEventTypeEx;         //Event type,substitute for dwEventType,refer to VCA_RULE_EVENT_TYPE_EX
             [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN)]
             public byte[] byRuleName;
             public VCA_EVENT_TYPE dwEventType;
             public tagNET_VCA_EVENT_UNION uEventParam;
             public void Init()
        ...
        public struct tagNET_VCA_RULE_ALARM
        {
            ...
            public System.UInt32 dwAbsTime;
        ...
        public struct NET_DVR_AUDIOEXCEPTION_ALARM
        {
            ...
            public byte byAlarmType;//alarmType£¬1-audio input exception£¬2-audio input changed£¬3-audio steep fall £¬4-audio Loss
            public uint byRes1;
            public byte wAudioDecibel;//the voice (for audio input changed);
            public NET_VCA_DEV_INFO struDevInfo;//Structure info           
        }
        //
