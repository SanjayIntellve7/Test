...
namespace AMS.Broker.WatchDogService.DataStore
{
    ...
    {     
        ...
        public DbSet<AMS.Broker.DataStore.TimeZone> TimeZone { get; set; }
       ...
       // public DbSet<tblANPRTransDetails> tblANPRTransDetails { get; set; } //trupti24Aug15 Device status
        ...
        public DbSet<SP_RDLHourlyWeatherReport_Result> SP_RDLHourlyWeatherReport_Result { get; set; }
        public DbSet<SP_GetAlertCount_Result> SP_GetAlertCount_Result { get; set; }
       ...
       // public DbSet<tblUserPrivileges> tblUserPrivileges { get; set; }

        public DbSet<tblInternalContactDetails> InternalContactDetails { get; set; }
        public DbSet<tblExternalContactDetails> ExternalContactDetails { get; set; }

        public DbSet<tblSOPType> tblSOPType { get; set; }
        public DbSet<tblSOPAction> tblSOPAction { get; set; }
        public DbSet<tblSOPAlertType> tblSOPAlertType { get; set; }
        public DbSet<tblSOPInputType> tblSOPInputType { get; set; }
        public DbSet<tblSOPMaster> tblSOPMaster { get; set; }
        public DbSet<tblSOPTriggerActionType> tblSOPTriggerActionType { get; set; }
        public DbSet<tblSOPTriggerCondition> tblSOPTriggerCondition { get; set; }
        public DbSet<tbluserdeviceinfo> tbluserdeviceinfo { get; set; } //amit 15062017
        public DbSet<tbldevicefeature> tbldevicefeature { get; set; } //amit 15062017
        public DbSet<tblEvents> tblEvents { get; set; } //amit 24072017

        public DbSet<SP_ReturnRuleDefinition_Result> SP_ReturnRuleDefinition_Result { get; set; } //amit 24072017

        public DbSet<tblTimeSyncinfo> tblTimeSyncinfo { get; set; } //amit 12032018

        public DbSet<SP_ReturnAlertEscalationNotificationMember_Result> SP_ReturnAlertEscalationNotificationMember_Result { get; set; } //amit 29032018
        public DbSet<SP_AlertEscalationNotification_Result> SP_AlertEscalationNotification_Result { get; set; } //amit 29032018
        public DbSet<tblEscalationNotificationInfo> tblEscalationNotificationInfo { get; set; } //amit 29032018
        public DbSet<tblAlertEscalationLog> tblAlertEscalationLog { get; set; } //amit 29032018
        public DbSet<tblMachineStatus> tblMachineStatus { get; set; } //amit 03052018
        public DbSet<tblANPRLPDetails> tblANPRLPDetails { get; set; } //amit 03052018

        public DbSet<tblSMTPConfiguration> tblSMTPConfiguration { get; set; } //amit 13102018

        public DbSet<tblSMSConfiguration> tblSMSConfiguration { get; set; } //amit 13102018
