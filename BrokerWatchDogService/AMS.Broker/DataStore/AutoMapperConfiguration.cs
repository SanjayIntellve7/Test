...
namespace AMS.Broker.WatchDogService.DataStore
{
    ...
    public static class AutoMapperConfiguration
    {
        ...
        public static void CreateAllMaps()
        {
            ...
            {    
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.ContactMethod, ContactMethodDto>();
                ...
                Mapper.CreateMap<Contracts.DTO.UserLocation, AMS.Broker.DataStore.UserLocation>();
                Mapper.CreateMap<AMS.Broker.DataStore.UserLocation, Contracts.DTO.UserLocation>();
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.Station, StationDTO>();

                Mapper.CreateMap<AMS.Broker.DataStore.Zone, GroupDTO>();
                Mapper.CreateMap<AMS.Broker.DataStore.Zone, ZoneDTO>().AfterMap(
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.Alert, AlertDTO>()
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.Info, InfoDTO>()
                    .AfterMap(
                        (db, dto) =>
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.Resource, ResourceDTO>();
                Mapper.CreateMap<AMS.Broker.DataStore.Area, AreaDTO>();

                Mapper.CreateMap<IncidentReportAlert, AlertDTO>(); //tbgeolocation

                Mapper.CreateMap<AMS.Broker.DataStore.IncidentReport, Contracts.DTO.IncidentReport>()
                ...
                Mapper.CreateMap<AMS.Broker.DataStore.ValuesLookUp, ValuesLookUpDTO>();
                ...
                Mapper.CreateMap<ZoneDTO, AMS.Broker.DataStore.Zone>()
                    .AfterMap(
                        (dto, db) =>
                ...
                Mapper.CreateMap<ScopeDto, AMS.Broker.DataStore.Scope>();

                Mapper.CreateMap<AMS.Broker.DataStore.TimeZone, TimeZoneDto>();
                ...
                Mapper.CreateMap<AlertDTO, AMS.Broker.DataStore.Alert>()
                    .AfterMap((dto, db) => db.Info = Mapper.Map<EntityCollection<AMS.Broker.DataStore.Info>>(dto.InfoCollection));

                Mapper.CreateMap<AreaDTO, AMS.Broker.DataStore.Area>()
                    .ForMember(x => x.Description, x => x.MapFrom(y => y.Description ?? string.Empty));

                Mapper.CreateMap<InfoDTO, AMS.Broker.DataStore.Info>()
                    .AfterMap((dto, db) =>
                                  {
                                      foreach (Contracts.DTO.Parameter eventCode in dto.ParametersCollection)
                                          db.Parameter.Add(new AMS.Broker.DataStore.Parameter
                                                               {
                                                                   Name = eventCode.Key,
                    ...
                    .AfterMap(
                        (dto, db) => { db.Resource = Mapper.Map<EntityCollection<AMS.Broker.DataStore.Resource>>(dto.ResourcesCollection); })
                    .AfterMap((dto, db) => db.Area = Mapper.Map<EntityCollection<AMS.Broker.DataStore.Area>>(dto.AreasCollection));
                ...
                Mapper.CreateMap<ResourceDTO, AMS.Broker.DataStore.Resource>()
                    .ForMember(x => x.Description, x => x.MapFrom(y => y.Description ?? String.Empty))
               ...
               Mapper.CreateMap<tblWeatherhourlyforecastDTO, tblWeatherhourlyforecast>();
                ...
                Mapper.CreateMap<TimeZoneDto, AMS.Broker.DataStore.TimeZone>();

                Mapper.CreateMap<AMS.Broker.DataStore.Scope, ScopeDto>();
        ...
        private static void CreateEventMapping()
        {
            ...
            Mapper.CreateMap<AMS.Broker.DataStore.Certainty, CertaintyDto>();
            Mapper.CreateMap<AMS.Broker.DataStore.MessageType, MessageTypeDto>();
            Mapper.CreateMap<AMS.Broker.DataStore.ResponseType, ResponseTypeDto>().ForMember(dto => dto.Name, opt => opt.MapFrom(db => db.Name));
            Mapper.CreateMap<AMS.Broker.DataStore.Severity, SeverityDto>();
            Mapper.CreateMap<AMS.Broker.DataStore.Status, StatusDto>();
            Mapper.CreateMap<AMS.Broker.DataStore.Urgency, UrgencyDto>();
            Mapper.CreateMap<AMS.Broker.DataStore.Category, CategoryDto>().ForMember(dto => dto.Name, opt => opt.MapFrom(db => db.Name));
            ...
            Mapper.CreateMap<CertaintyDto, AMS.Broker.DataStore.Certainty>();
            Mapper.CreateMap<MessageTypeDto, AMS.Broker.DataStore.MessageType>();
            Mapper.CreateMap<ResponseTypeDto, AMS.Broker.DataStore.ResponseType>().ForMember(db => db.Name, opt => opt.MapFrom(dto => dto.Name)); ;
            Mapper.CreateMap<SeverityDto, AMS.Broker.DataStore.Severity>();
            Mapper.CreateMap<StatusDto, AMS.Broker.DataStore.Status>();
            Mapper.CreateMap<UrgencyDto, AMS.Broker.DataStore.Urgency>();
            Mapper.CreateMap<CategoryDto, AMS.Broker.DataStore.Category>().ForMember(db => db.Name, opt => opt.MapFrom(dto => dto.Name));
            Mapper.CreateMap<EventTemplateDto, EventTemplate>();
            Mapper.CreateMap<AMS.Broker.DataStore.Event, EventDTO>();
            Mapper.CreateMap<EventDTO, AMS.Broker.DataStore.Event>();
        ...
        {
            Mapper.CreateMap<AMS.Broker.DataStore.User, UserDto>()
            ...
            Mapper.CreateMap<Rhino.Security.Model.Permission, PermissionDto>()
                  .ForMember(dto => dto.User, opt => opt.MapFrom(db => (AMS.Broker.DataStore.User)db.User));

            Mapper.CreateMap<UserDto, AMS.Broker.DataStore.User>();
