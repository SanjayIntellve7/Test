...
namespace AMS.Broker.WatchDogService
{
    internal static class Storage
    {
        ...
        public static string IsCameraStatusEnable
        {
            get { return GetConfigValue("IsCameraStatusEnable"); }////ConfigurationManager.AppSettings["CameraStatusTimeSec"]); }
        }
        ...
        public static string CamStatusDBServer
        {
            get { return GetConfigValue("CamStatusDBServer"); }//ConfigurationManager.AppSettings["ANPRServer"]; }
        }
        public static string CamStatusDBUsername
        {
            get { return GetConfigValue("CamStatusDBUsername"); }//ConfigurationManager.AppSettings["ANPRUsername"]; }
        }

        public static string CamStatusDBPassword
        {
            get { return GetConfigValue("CamStatusDBPassword"); }//ConfigurationManager.AppSettings["ANPRPassword"]; }
        }

        public static string CamStatusDB
        {
            get { return GetConfigValue("CamStatusDB"); }//ConfigurationManager.AppSettings["ANPRDB"]; }
        }
        ...
        public static string DeviceTimeSyncInterval
        {
            get { return GetConfigValue("DeviceTimeSyncInterval"); }//ConfigurationManager.AppSettings["IsLogEnable"]; }
        }
        public static string ConcurrDeviceSyncCount
        {
            get { return GetConfigValue("ConcurrDeviceSyncCount"); }//ConfigurationManager.AppSettings["IsLogEnable"]; }
        }
        public static string ConnectionTimeOut
        {
            get { return GetConfigValue("ConnectionTimeOut"); }//ConfigurationManager.AppSettings["IsLogEnable"]; }
        }
        public static string HikConnectTime
        {
            get { return GetConfigValue("HikConnectTime"); }//ConfigurationManager.AppSettings["IsLogEnable"]; }
        }

        public static string DeviceTimeSyncEnable
        {
            get { return GetConfigValue("DeviceTimeSyncEnable"); }//ConfigurationManager.AppSettings["IsLogEnable"]; }
        }

        //for esacllation notification
        public static string IsEscallationInformEnable
        {
            get { return GetConfigValue("IsEscallationInformEnable"); }
        }
        public static string EscallationWaitInterval
        {
            get { return GetConfigValue("EscallationWaitInterval"); }
        }

        public static string EscallationTime
        {
            get { return GetConfigValue("EscallationTime"); }
        }

        public static string ServerClientCommEnable //amit 03052018
        {
            get { return GetConfigValue("ServerClientCommEnable"); }
        }

        public static string ServerClientCommInterval //amit 03052018
        {
            get { return GetConfigValue("ServerClientCommInterval"); }
        }

        public static string ServerClientEmailDisplayName //amit 03052018
        {
            get { return GetConfigValue("ServerClientEmailDisplayName"); }
        }

        public static string ServerClientEmailSubject //amit 03052018
        {
            get { return GetConfigValue("ServerClientEmailSubject"); }
        }
        public static string ServerClientToEmailId //amit 03052018
        {
            get { return GetConfigValue("ServerClientToEmailId"); }
        }  
        public static string ServerClientSMSMobNo //amit 03052018
        {
            get { return GetConfigValue("ServerClientSMSMobNo"); }
        }        
        
        public static string AlertPushMode //amit 03052018
        {
            get { return GetConfigValue("AlertPushMode"); }
        }
        public static string StationServiceEnpoint //amit 03052018
        {
            get { return GetConfigValue("StationServiceEnpoint"); }
        }
        public static string SecondaryStationServiceEnpoint //amit 03052018
        {
            get { return GetConfigValue("SecondaryStationServiceEnpoint"); }
        }
        
        public static string WorkingMode //amit 03052018
        {
            get { return GetConfigValue("WorkingMode"); }
        }

        public static string AnprDeviceStatusEnable //amit 30062018
        {
            get { return GetConfigValue("AnprDeviceStatusEnable"); }
        }
        public static string AnprDeviceStatusInterval //amit 30062018
        {
            get { return GetConfigValue("AnprDeviceStatusInterval"); }
        }

        public static string AnprDeviceStatusAlertTime //amit 30062018
        {
            get { return GetConfigValue("AnprDeviceStatusAlertTime"); }
        }

        public static string ServiceExitEmail //amit 30062018
        {
            get { return GetConfigValue("ServiceExitEmail"); }
        }    
