...
namespace AMS.Broker.WatchDogService.Test
{
    ...
    {
        private static ISystemGetOperationService _systemService;
        private static ILookupService _lookupService;
        private static IAccountsGetOperationService _accountService;
        ...
        private IControllerGetOperationService __controllerService;

        public VideoAnalyticsManagerServiceTest()
        {
            _systemService = BrokerService.Container.Resolve<ISystemGetOperationService>();
            _lookupService = BrokerService.Container.Resolve<ILookupService>();
            _accountService = BrokerService.Container.Resolve<IAccountsGetOperationService>();
            ...
            __controllerService = BrokerService.Container.Resolve<IControllerGetOperationService>();
