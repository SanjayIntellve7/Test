...
namespace CacheAspect.Attributes
{
    public static partial class Cache
    {
        ...
        public class Cacheable : OnMethodBoundaryAspect
        {
            ...
            public Cacheable(String groupName, String parameterProperty)
            {
                KeyBuilder.GroupName = groupName;
                KeyBuilder.Settings = CacheSettings.UseProperty;
                KeyBuilder.ParameterProperty = parameterProperty;
            }

            protected Cacheable(String groupName, CacheSettings settings, String parameterProperty)
            {
                KeyBuilder.GroupName = groupName;
            ...
            protected Cacheable(String groupName)
            ...
            private bool IsTooOld(DateTime time)
            {
                ...
                return DateTime.Now - time > CacheService.TimeToLive;                
            }
