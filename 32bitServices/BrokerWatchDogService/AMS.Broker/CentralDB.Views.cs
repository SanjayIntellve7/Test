...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsF6F9817656423095F60A8FBC8781F59CBB902DFE748DF6623AA36C18AEC62D6C))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySetsF6F9817656423095F60A8FBC8781F59CBB902DFE748DF6623AA36C18AEC62D6C : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySetsF6F9817656423095F60A8FBC8781F59CBB902DFE748DF6623AA36C18AEC62D6C()
        {
            this.EdmEntityContainerName = "Entities";
            this.StoreEntityContainerName = "CentralDBModelStoreContainer";
            this.HashOverMappingClosure = "646b404e41402f258472bd845c8cd9521c04b82ceabd591530fe273743fa8891";
            this.HashOverAllExtentViews = "24921473199adf4ca7ff1f55c21f76d38255a6ef47203192a77c75967c869ac1";
            this.ViewCount = 335;
        }
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(4300);
            ...
            viewString.Append("1.NvrCamera_Mediaurl)\r\n    FROM (\r\n        SELECT \r\n            T.DeviceId AS Nv");
            viewString.Append("rCamera_CameraId, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).FPS AS Nv");
            viewString.Append("rCamera_FPS, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).AnalyticAlgori");
            viewString.Append("thmTypeId AS NvrCamera_AnalyticAlgorithmTypeId, \r\n            TREAT(T AS [Centra");
            viewString.Append("lDBModel.NvrCamera]).Version AS NvrCamera_Version, \r\n            TREAT(T AS [Cen");
            viewString.Append("tralDBModel.NvrCamera]).MaxBlobSize AS NvrCamera_MaxBlobSize, \r\n            TREA");
            viewString.Append("T(T AS [CentralDBModel.NvrCamera]).MinBlobSize AS NvrCamera_MinBlobSize, \r\n     ");
            viewString.Append("       TREAT(T AS [CentralDBModel.NvrCamera]).AlarmDelay AS NvrCamera_AlarmDelay");
            viewString.Append(", \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).UpdateRate AS NvrCamera_U");
            viewString.Append("pdateRate, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Width AS NvrCame");
            viewString.Append("ra_Width, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Height AS NvrCame");
            viewString.Append("ra_Height, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).ZoneRows AS NvrC");
            viewString.Append("amera_ZoneRows, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).ZoneColumns");
            viewString.Append(" AS NvrCamera_ZoneColumns, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).");
            viewString.Append("ZoneData AS NvrCamera_ZoneData, \r\n            TREAT(T AS [CentralDBModel.NvrCame");
            viewString.Append("ra]).AnalyticsEventTemplateId AS NvrCamera_AnalyticsEventTemplateId, \r\n         ");
            viewString.Append("   TREAT(T AS [CentralDBModel.NvrCamera]).IsPtz AS NvrCamera_IsPtz, \r\n          ");
            viewString.Append("  TREAT(T AS [CentralDBModel.NvrCamera]).CameraIp AS NvrCamera_CameraIp, \r\n     ");
            viewString.Append("       TREAT(T AS [CentralDBModel.NvrCamera]).LineStart AS NvrCamera_LineStart, ");
            viewString.Append("\r\n            TREAT(T AS [CentralDBModel.NvrCamera]).LineEnd AS NvrCamera_LineEn");
            viewString.Append("d, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).DirectionFlag AS NvrCame");
            viewString.Append("ra_DirectionFlag, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CameraUrl");
            viewString.Append(" AS NvrCamera_CameraUrl, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Ca");
            viewString.Append("meraPort AS NvrCamera_CameraPort, \r\n            TREAT(T AS [CentralDBModel.NvrCa");
            viewString.Append("mera]).CamUser AS NvrCamera_CamUser, \r\n            TREAT(T AS [CentralDBModel.Nv");
            viewString.Append("rCamera]).CamPassword AS NvrCamera_CamPassword, \r\n            TREAT(T AS [Centra");
            viewString.Append("lDBModel.NvrCamera]).MaxBlobWidth AS NvrCamera_MaxBlobWidth, \r\n            TREAT");
            viewString.Append("(T AS [CentralDBModel.NvrCamera]).MaxBlobHeight AS NvrCamera_MaxBlobHeight, \r\n  ");
            viewString.Append("          TREAT(T AS [CentralDBModel.NvrCamera]).MinBlobWidth AS NvrCamera_MinBl");
            viewString.Append("obWidth, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).MinBlobHeight AS N");
            viewString.Append("vrCamera_MinBlobHeight, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Cam");
            viewString.Append("eraType AS NvrCamera_CameraType, \r\n            TREAT(T AS [CentralDBModel.NvrCam");
            viewString.Append("era]).AnalyticsServerIp AS NvrCamera_AnalyticsServerIp, \r\n            TREAT(T AS");
            viewString.Append(" [CentralDBModel.NvrCamera]).Lane1 AS NvrCamera_Lane1, \r\n            TREAT(T AS ");
            viewString.Append("[CentralDBModel.NvrCamera]).Lane2 AS NvrCamera_Lane2, \r\n            TREAT(T AS [");
            viewString.Append("CentralDBModel.NvrCamera]).Lane3 AS NvrCamera_Lane3, \r\n            TREAT(T AS [C");
            viewString.Append("entralDBModel.NvrCamera]).NoOfLens AS NvrCamera_NoOfLens, \r\n            TREAT(T ");
            viewString.Append("AS [CentralDBModel.NvrCamera]).ChanelNo AS NvrCamera_ChanelNo, \r\n            TRE");
            viewString.Append("AT(T AS [CentralDBModel.NvrCamera]).IsEdgeAnalytics AS NvrCamera_IsEdgeAnalytics");
            viewString.Append(", \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Mediaurl AS NvrCamera_Med");
            viewString.Append("iaurl, \r\n            True AS _from0\r\n        FROM Entities.Device AS T\r\n        ");
            viewString.Append("WHERE T IS OF (ONLY [CentralDBModel.NvrCamera])\r\n    ) AS T1");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(6543);
            viewString.Append("\r\n    SELECT VALUE -- Constructing Device\r\n        CASE\r\n            WHEN NOT(T3");
            ...
            viewString.Append(" T3.NvrCamera_ChanelNo, T3.NvrCamera_IsEdgeAnalytics, T3.NvrCamera_Mediaurl)\r\n  ");
            viewString.Append("      END\r\n    FROM (\r\n        SELECT T1.Device_DeviceId, T1.Device_ExternalId, ");
            viewString.Append("T1.Device_Description, T1.Device_Metadata, T1.Device_Type, T1.Device_Lat, T1.Dev");
            viewString.Append("ice_Long, T1.Device_Altitude, T1.Device_LocationDescription, T1.Device_CameraGui");
            viewString.Append("d, T1.Device_NvrId, T1.Device_SiteId, T1.Device_ActiveAlert, T1.Device_HasPvAnal");
            viewString.Append("ytics, T1.Device_HasSzAnalytics, T1.Device_HasAbAnalytics, T1.Device_InterfaceId");
            viewString.Append(", T1.Device_IsMovable, T1.Device_Name, T2.NvrCamera_FPS, T2.NvrCamera_AnalyticAl");
            viewString.Append("gorithmTypeId, T2.NvrCamera_Version, T2.NvrCamera_MaxBlobSize, T2.NvrCamera_MinB");
            viewString.Append("lobSize, T2.NvrCamera_AlarmDelay, T2.NvrCamera_UpdateRate, T2.NvrCamera_Width, T");
            viewString.Append("2.NvrCamera_Height, T2.NvrCamera_ZoneRows, T2.NvrCamera_ZoneColumns, T2.NvrCamer");
            viewString.Append("a_ZoneData, T2.NvrCamera_AnalyticsEventTemplateId, T2.NvrCamera_IsPtz, T2.NvrCam");
            viewString.Append("era_CameraIp, T2.NvrCamera_LineStart, T2.NvrCamera_LineEnd, T2.NvrCamera_Directi");
            viewString.Append("onFlag, T2.NvrCamera_CameraUrl, T2.NvrCamera_CameraPort, T2.NvrCamera_CamUser, T");
            viewString.Append("2.NvrCamera_CamPassword, T2.NvrCamera_MaxBlobWidth, T2.NvrCamera_MaxBlobHeight, ");
            viewString.Append("T2.NvrCamera_MinBlobWidth, T2.NvrCamera_MinBlobHeight, T2.NvrCamera_CameraType, ");
            viewString.Append("T2.NvrCamera_AnalyticsServerIp, T2.NvrCamera_Lane1, T2.NvrCamera_Lane2, T2.NvrCa");
            viewString.Append("mera_Lane3, T2.NvrCamera_NoOfLens, T2.NvrCamera_ChanelNo, T2.NvrCamera_IsEdgeAna");
            viewString.Append("lytics, T2.NvrCamera_Mediaurl, (T2._from0 AND T2._from0 IS NOT NULL) AS _from0, ");
            viewString.Append("T1._from1\r\n        FROM  (\r\n            SELECT \r\n                T.DeviceId AS D");
            viewString.Append("evice_DeviceId, \r\n                T.ExternalId AS Device_ExternalId, \r\n         ");
            viewString.Append("       T.Description AS Device_Description, \r\n                T.Metadata AS Devi");
            viewString.Append("ce_Metadata, \r\n                T.Type AS Device_Type, \r\n                T.Lat AS");
            viewString.Append(" Device_Lat, \r\n                T.Long AS Device_Long, \r\n                T.Altitu");
            viewString.Append("de AS Device_Altitude, \r\n                T.LocationDescription AS Device_Locatio");
            viewString.Append("nDescription, \r\n                T.CameraGuid AS Device_CameraGuid, \r\n           ");
            viewString.Append("     T.NvrId AS Device_NvrId, \r\n                T.SiteId AS Device_SiteId, \r\n   ");
            viewString.Append("             T.ActiveAlert AS Device_ActiveAlert, \r\n                T.HasPvAnaly");
            viewString.Append("tics AS Device_HasPvAnalytics, \r\n                T.HasSzAnalytics AS Device_HasS");
            viewString.Append("zAnalytics, \r\n                T.HasAbAnalytics AS Device_HasAbAnalytics, \r\n     ");
            viewString.Append("           T.InterfaceId AS Device_InterfaceId, \r\n                T.IsMovable AS");
            viewString.Append(" Device_IsMovable, \r\n                T.Name AS Device_Name, \r\n                Tr");
            viewString.Append("ue AS _from1\r\n            FROM CentralDBModelStoreContainer.Device AS T) AS T1\r\n");
            viewString.Append("            LEFT OUTER JOIN (\r\n            SELECT \r\n                T.CameraId A");
            viewString.Append("S Device_DeviceId, \r\n                T.FPS AS NvrCamera_FPS, \r\n                T");
            viewString.Append(".AnalyticAlgorithmTypeId AS NvrCamera_AnalyticAlgorithmTypeId, \r\n               ");
            viewString.Append(" T.Version AS NvrCamera_Version, \r\n                T.MaxBlobSize AS NvrCamera_Ma");
            viewString.Append("xBlobSize, \r\n                T.MinBlobSize AS NvrCamera_MinBlobSize, \r\n         ");
            viewString.Append("       T.AlarmDelay AS NvrCamera_AlarmDelay, \r\n                T.UpdateRate AS N");
            viewString.Append("vrCamera_UpdateRate, \r\n                T.Width AS NvrCamera_Width, \r\n           ");
            viewString.Append("     T.Height AS NvrCamera_Height, \r\n                T.ZoneRows AS NvrCamera_Zon");
            viewString.Append("eRows, \r\n                T.ZoneColumns AS NvrCamera_ZoneColumns, \r\n             ");
            viewString.Append("   T.ZoneData AS NvrCamera_ZoneData, \r\n                T.AnalyticsEventTemplateI");
            viewString.Append("d AS NvrCamera_AnalyticsEventTemplateId, \r\n                T.IsPtz AS NvrCamera_");
            viewString.Append("IsPtz, \r\n                T.CameraIp AS NvrCamera_CameraIp, \r\n                T.L");
            viewString.Append("ineStart AS NvrCamera_LineStart, \r\n                T.LineEnd AS NvrCamera_LineEn");
            viewString.Append("d, \r\n                T.DirectionFlag AS NvrCamera_DirectionFlag, \r\n             ");
            viewString.Append("   T.CameraUrl AS NvrCamera_CameraUrl, \r\n                T.CameraPort AS NvrCame");
            viewString.Append("ra_CameraPort, \r\n                T.CamUser AS NvrCamera_CamUser, \r\n             ");
            viewString.Append("   T.CamPassword AS NvrCamera_CamPassword, \r\n                T.MaxBlobWidth AS N");
            viewString.Append("vrCamera_MaxBlobWidth, \r\n                T.MaxBlobHeight AS NvrCamera_MaxBlobHei");
            viewString.Append("ght, \r\n                T.MinBlobWidth AS NvrCamera_MinBlobWidth, \r\n             ");
            viewString.Append("   T.MinBlobHeight AS NvrCamera_MinBlobHeight, \r\n                T.CameraType AS");
            viewString.Append(" NvrCamera_CameraType, \r\n                T.AnalyticsServerIp AS NvrCamera_Analyt");
            viewString.Append("icsServerIp, \r\n                T.Lane1 AS NvrCamera_Lane1, \r\n                T.L");
            viewString.Append("ane2 AS NvrCamera_Lane2, \r\n                T.Lane3 AS NvrCamera_Lane3, \r\n       ");
            viewString.Append("         T.NoOfLens AS NvrCamera_NoOfLens, \r\n                T.ChanelNo AS NvrCa");
            viewString.Append("mera_ChanelNo, \r\n                T.IsEdgeAnalytics AS NvrCamera_IsEdgeAnalytics,");
            viewString.Append(" \r\n                T.Mediaurl AS NvrCamera_Mediaurl, \r\n                True AS _");
            viewString.Append("from0\r\n            FROM CentralDBModelStoreContainer.NvrCamera AS T) AS T2\r\n    ");
            viewString.Append("        ON T1.Device_DeviceId = T2.Device_DeviceId\r\n    ) AS T3");
