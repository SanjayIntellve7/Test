...
namespace AMS.Broker.WatchDogService.RihnoSecurity.Membership
{
        ...
        public override string[] FindUsersInRole(string roleName, string usernameToMatch)
        {
            ...
            using (var ctx = new CentralDBEntities())
            {
                ...
                foreach (var perm in permissions)
                {
                    if (perm.Allow)
                    {
                        var usrId = (perm.User as AMS.Broker.DataStore.User).UserId;
        ...
        public override string[] GetUsersInRole(string roleName)
        {
            ...
            using (var ctx = new CentralDBEntities())
            {
                ...
                foreach (var prem in premissions)
                {
                    if (prem.Allow)
                    {
                        var usrId = (prem.User as AMS.Broker.DataStore.User).UserId;
                        var usr = ctx.User.Single(user => user.UserId == usrId);
