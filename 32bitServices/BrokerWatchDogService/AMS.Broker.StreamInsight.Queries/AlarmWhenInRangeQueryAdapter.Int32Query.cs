...
namespace AMS.Broker.WatchDogService.StreamInsight.Queries
{
    ...
    public class AlarmWhenInRangeQueryAdapterInt32Query : StreamingQueryProvider<AlarmWhenInRangeQueryAdapterConfig>
    {
    ...
    /// </summary>
    public class AlarmWhenInRangeQueryAdapterConfig : QueryProviderConfigurationBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleQueryAdapterQueryProviderConfig"/> class.
        /// </summary>
        public AlarmWhenInRangeQueryAdapterConfig() : base() { }
