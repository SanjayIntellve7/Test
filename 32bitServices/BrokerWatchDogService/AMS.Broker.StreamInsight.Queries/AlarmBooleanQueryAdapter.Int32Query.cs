...
namespace AMS.Broker.WatchDogService.StreamInsight.Queries
{
    ...
    public class AlarmAboveLevelQueryAdapterBooleanQuery : StreamingQueryProvider<AlarmAboveLevelQueryAdapterBooleanConfig>
    {
        ...
        {
            var inputStream = CreateSourceStream<bool>(Source);
            ...
            var query =
                ...
                where item.Value == Configuration.AlarmIndicator && item.ItemId == refItem.StreamInsightId
                select new
                {
                    Name = item.ItemId,
    ...
    /// </summary>
    public class AlarmAboveLevelQueryAdapterBooleanConfig : QueryProviderConfigurationBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleQueryAdapterQueryProviderConfig"/> class.
        /// </summary>
        public AlarmAboveLevelQueryAdapterBooleanConfig() : base() { }
        ...
        public override void Initialize(PlugInConfigurationElement configurationElement)
        {
            ...
            AlarmIndicator = configurationElement.GetSettingAsBool("AlarmIndicator", false, false);
        }
        ...
        public Boolean AlarmIndicator { get; set; }
    }
