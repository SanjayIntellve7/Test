namespace AMS.Orchestrations {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"AMS.Orchestrations.UsersService__x32020_ams+GetUsersListByAlertGroup", typeof(global::AMS.Orchestrations.UsersService__x32020_ams.GetUsersListByAlertGroup))]
  ...
  <xsl:template match=""/s0:Alert"">
    <ns0:GetUsersListByAlertGroup>
      <ns0:content>
        ...
        private const string _strTrgSchemasList0 = @"AMS.Orchestrations.UsersService__x32020_ams+GetUsersListByAlertGroup";
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"AMS.Orchestrations.UsersService__x32020_ams+GetUsersListByAlertGroup";
                return _TrgSchemas;
            }
        }
    }
