...
namespace AMS.Broker.Contracts.DTO
{
    ...
    public partial class tblCameraStatusDto
    {
        ...
        [DataMember()]
        public Nullable<Boolean> StatusOffline { get; set; }

        public tblCameraStatusDto()
        {
        }

        public tblCameraStatusDto(Int32 cameraStatusID, Nullable<Int32> deviceID, Nullable<Boolean> status, String remarks, String cameraIp, String cameraName, Nullable<Boolean> statusOffline)
        {
