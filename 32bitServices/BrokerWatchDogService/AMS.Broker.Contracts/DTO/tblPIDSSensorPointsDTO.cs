...
{  
    ...
    {      
        ...
        [DataMember()]
        public String CableDistance { get; set; }

        [DataMember()]
        public String PerimeterDistance { get; set; }
        ...
        public tblPIDSSensorPointsDTO(Int64 iD, Nullable<Int32> sensorID_ID, Nullable<Int32> sensorID, Nullable<Int32> sequenceNo, Nullable<double> lat, Nullable<double> lon, String cableDistance, String perimeterDistance, String calibrationPoint, Nullable<double> altitude)
        {
            this.ID = iD;
