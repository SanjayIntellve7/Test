...
namespace AMS.Broker.Contracts.Services
{
    ...
    public interface IMannapuramAlertCreationService
    {
       ...
       // void CreateMannapuramAlert(DeviceDto _DeviceDto, string strEventCode, string Serverity, string AlertdateTime, string strHeadline, int tblEventID);
        ...
        [OperationContract]
        void startAlertRuleProcess(string PatriotTableID, string Client_no, string BranchID, string externalid, string eventcode, string AlertdateTime, string Description, int tblEventID);
