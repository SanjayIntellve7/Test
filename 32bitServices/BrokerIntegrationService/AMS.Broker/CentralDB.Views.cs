...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets421519AE388F7FDEA2F620566B780F30F2EEDE15643751ABEFE94CD58561B21B))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets421519AE388F7FDEA2F620566B780F30F2EEDE15643751ABEFE94CD58561B21B : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets421519AE388F7FDEA2F620566B780F30F2EEDE15643751ABEFE94CD58561B21B()
        {
            this.EdmEntityContainerName = "Entities";
            this.StoreEntityContainerName = "CentralDBModelStoreContainer";
            this.HashOverMappingClosure = "944ba890bd7fc907413ad97c781e6fb0194860c1b4bcfb72133c3b40ed01ba33";
            this.HashOverAllExtentViews = "e422b854f666595cc05333347a74e82a96e232fee40c3f5ef497b390f2ac9b9c";
            this.ViewCount = 305;
        }
    ...
    SELECT VALUE -- Constructing Alert
        [CentralDBModel.Store.Alert](T1.Alert_AlertId, T1.Alert_Identifier, T1.Alert_Sender, T1.Alert_Sent, T1.Alert_StatusId, T1.Alert_MessageTypeId, T1.Alert_ScopeId, T1.Alert_Source, T1.Alert_Restriction, T1.Alert_Addresses, T1.Alert_Code, T1.Alert_Note, T1.Alert_References, T1.Alert_Incidents, T1.Alert_DeviceId, T1.Alert_ReceivedDateTime, T1.Alert_MembershipUserId, T1.Alert_AlertOwner, T1.Alert_Alertzone)
    FROM (
        SELECT 
            ...
            T.Addresses AS Alert_Addresses, 
            T.Code AS Alert_Code, 
            T.Note AS Alert_Note, 
            T.References AS Alert_References, 
            T.Incidents AS Alert_Incidents, 
            T.DeviceId AS Alert_DeviceId, 
            T.ReceivedDateTime AS Alert_ReceivedDateTime, 
            T.MembershipUserId AS Alert_MembershipUserId, 
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(4192);
            ...
            viewString.Append("3, T1.NvrCamera_NoOfLens, T1.NvrCamera_ChanelNo, T1.NvrCamera_IsEdgeAnalytics)\r\n");
            viewString.Append("    FROM (\r\n        SELECT \r\n            T.DeviceId AS NvrCamera_CameraId, \r\n   ");
            viewString.Append("         TREAT(T AS [CentralDBModel.NvrCamera]).FPS AS NvrCamera_FPS, \r\n        ");
            viewString.Append("    TREAT(T AS [CentralDBModel.NvrCamera]).AnalyticAlgorithmTypeId AS NvrCamera_");
            viewString.Append("AnalyticAlgorithmTypeId, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Ve");
            viewString.Append("rsion AS NvrCamera_Version, \r\n            TREAT(T AS [CentralDBModel.NvrCamera])");
            viewString.Append(".MaxBlobSize AS NvrCamera_MaxBlobSize, \r\n            TREAT(T AS [CentralDBModel.");
            viewString.Append("NvrCamera]).MinBlobSize AS NvrCamera_MinBlobSize, \r\n            TREAT(T AS [Cent");
            viewString.Append("ralDBModel.NvrCamera]).AlarmDelay AS NvrCamera_AlarmDelay, \r\n            TREAT(T");
            viewString.Append(" AS [CentralDBModel.NvrCamera]).UpdateRate AS NvrCamera_UpdateRate, \r\n          ");
            ...
            viewString.Append("       TREAT(T AS [CentralDBModel.NvrCamera]).ZoneColumns AS NvrCamera_ZoneColum");
            viewString.Append("ns, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).ZoneData AS NvrCamera_Z");
            viewString.Append("oneData, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).AnalyticsEventTemp");
            viewString.Append("lateId AS NvrCamera_AnalyticsEventTemplateId, \r\n            TREAT(T AS [CentralD");
            viewString.Append("BModel.NvrCamera]).IsPtz AS NvrCamera_IsPtz, \r\n            TREAT(T AS [CentralDB");
            viewString.Append("Model.NvrCamera]).CameraIp AS NvrCamera_CameraIp, \r\n            TREAT(T AS [Cent");
            viewString.Append("ralDBModel.NvrCamera]).LineStart AS NvrCamera_LineStart, \r\n            TREAT(T A");
            viewString.Append("S [CentralDBModel.NvrCamera]).LineEnd AS NvrCamera_LineEnd, \r\n            TREAT(");
            viewString.Append("T AS [CentralDBModel.NvrCamera]).DirectionFlag AS NvrCamera_DirectionFlag, \r\n   ");
            viewString.Append("         TREAT(T AS [CentralDBModel.NvrCamera]).CameraUrl AS NvrCamera_CameraUrl");
            viewString.Append(", \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CameraPort AS NvrCamera_C");
            viewString.Append("ameraPort, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CamUser AS NvrCa");
            viewString.Append("mera_CamUser, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CamPassword A");
            viewString.Append("S NvrCamera_CamPassword, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Ma");
            viewString.Append("xBlobWidth AS NvrCamera_MaxBlobWidth, \r\n            TREAT(T AS [CentralDBModel.N");
            viewString.Append("vrCamera]).MaxBlobHeight AS NvrCamera_MaxBlobHeight, \r\n            TREAT(T AS [C");
            viewString.Append("entralDBModel.NvrCamera]).MinBlobWidth AS NvrCamera_MinBlobWidth, \r\n            ");
            viewString.Append("TREAT(T AS [CentralDBModel.NvrCamera]).MinBlobHeight AS NvrCamera_MinBlobHeight,");
            viewString.Append(" \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CameraType AS NvrCamera_Ca");
            viewString.Append("meraType, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).AnalyticsServerIp");
            viewString.Append(" AS NvrCamera_AnalyticsServerIp, \r\n            TREAT(T AS [CentralDBModel.NvrCam");
            viewString.Append("era]).Lane1 AS NvrCamera_Lane1, \r\n            TREAT(T AS [CentralDBModel.NvrCame");
            viewString.Append("ra]).Lane2 AS NvrCamera_Lane2, \r\n            TREAT(T AS [CentralDBModel.NvrCamer");
            viewString.Append("a]).Lane3 AS NvrCamera_Lane3, \r\n            TREAT(T AS [CentralDBModel.NvrCamera");
            viewString.Append("]).NoOfLens AS NvrCamera_NoOfLens, \r\n            TREAT(T AS [CentralDBModel.NvrC");
            viewString.Append("amera]).ChanelNo AS NvrCamera_ChanelNo, \r\n            TREAT(T AS [CentralDBModel");
            viewString.Append(".NvrCamera]).IsEdgeAnalytics AS NvrCamera_IsEdgeAnalytics, \r\n            True AS");
            viewString.Append(" _from0\r\n        FROM Entities.Device AS T\r\n        WHERE T IS OF (ONLY [Central");
            viewString.Append("DBModel.NvrCamera])\r\n    ) AS T1");
    ...
    SELECT VALUE -- Constructing IncidentReportCamera
        [CentralDBModel.Store.IncidentReportCamera](T1.IncidentReportCamera_IncidentReportCamerasId, T1.IncidentReportCamera_IncidentReportId, T1.IncidentReportCamera_CameraId, T1.IncidentReportCamera_Sequence, T1.IncidentReportCamera_PlyDateTime)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing IncidentReportStatus
        [CentralDBModel.Store.IncidentReportStatus](T1.IncidentReportStatus_IncidentReportStatusId, T1.IncidentReportStatus_IncidentReportId, T1.IncidentReportStatus_ChangeDate, T1.IncidentReportStatus_Status, T1.IncidentReportStatus_Notes, T1.IncidentReportStatus_UpdatedBy)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing ResourcesData
        [CentralDBModel.Store.ResourcesData](T1.ResourcesData_Id, T1.ResourcesData_Data, T1.ResourcesData_EvidenceType)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Alert
        [CentralDBModel.Alert](T1.Alert_AlertId, T1.Alert_Identifier, T1.Alert_Sender, T1.Alert_Sent, T1.Alert_StatusId, T1.Alert_MessageTypeId, T1.Alert_ScopeId, T1.Alert_Source, T1.Alert_Restriction, T1.Alert_Addresses, T1.Alert_Code, T1.Alert_Note, T1.Alert_References, T1.Alert_Incidents, T1.Alert_DeviceId, T1.Alert_ReceivedDateTime, T1.Alert_MembershipUserId, T1.Alert_AlertOwner, T1.Alert_Alertzone)
    FROM (
        SELECT 
            T.AlertId AS Alert_AlertId, 
            T.Identifier AS Alert_Identifier, 
            ...
            T.Alertzone AS Alert_Alertzone, 
            True AS _from0
        FROM CentralDBModelStoreContainer.Alert AS T
    ) AS T1");
        }
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(6445);
            viewString.Append("\r\n    SELECT VALUE -- Constructing Device\r\n        CASE\r\n            WHEN NOT(T3");
            ...
            viewString.Append(" T3.NvrCamera_ChanelNo, T3.NvrCamera_IsEdgeAnalytics)\r\n        END\r\n    FROM (\r\n");
            viewString.Append("        SELECT T1.Device_DeviceId, T1.Device_ExternalId, T1.Device_Description, ");
            viewString.Append("T1.Device_Metadata, T1.Device_Type, T1.Device_Lat, T1.Device_Long, T1.Device_Alt");
            viewString.Append("itude, T1.Device_LocationDescription, T1.Device_CameraGuid, T1.Device_NvrId, T1.");
            viewString.Append("Device_SiteId, T1.Device_ActiveAlert, T1.Device_HasPvAnalytics, T1.Device_HasSzA");
            viewString.Append("nalytics, T1.Device_HasAbAnalytics, T1.Device_InterfaceId, T1.Device_IsMovable, ");
            viewString.Append("T1.Device_Name, T2.NvrCamera_FPS, T2.NvrCamera_AnalyticAlgorithmTypeId, T2.NvrCa");
            viewString.Append("mera_Version, T2.NvrCamera_MaxBlobSize, T2.NvrCamera_MinBlobSize, T2.NvrCamera_A");
            viewString.Append("larmDelay, T2.NvrCamera_UpdateRate, T2.NvrCamera_Width, T2.NvrCamera_Height, T2.");
            viewString.Append("NvrCamera_ZoneRows, T2.NvrCamera_ZoneColumns, T2.NvrCamera_ZoneData, T2.NvrCamer");
            viewString.Append("a_AnalyticsEventTemplateId, T2.NvrCamera_IsPtz, T2.NvrCamera_CameraIp, T2.NvrCam");
            viewString.Append("era_LineStart, T2.NvrCamera_LineEnd, T2.NvrCamera_DirectionFlag, T2.NvrCamera_Ca");
            viewString.Append("meraUrl, T2.NvrCamera_CameraPort, T2.NvrCamera_CamUser, T2.NvrCamera_CamPassword");
            viewString.Append(", T2.NvrCamera_MaxBlobWidth, T2.NvrCamera_MaxBlobHeight, T2.NvrCamera_MinBlobWid");
            viewString.Append("th, T2.NvrCamera_MinBlobHeight, T2.NvrCamera_CameraType, T2.NvrCamera_AnalyticsS");
            viewString.Append("erverIp, T2.NvrCamera_Lane1, T2.NvrCamera_Lane2, T2.NvrCamera_Lane3, T2.NvrCamer");
            viewString.Append("a_NoOfLens, T2.NvrCamera_ChanelNo, T2.NvrCamera_IsEdgeAnalytics, (T2._from0 AND ");
            viewString.Append("T2._from0 IS NOT NULL) AS _from0, T1._from1\r\n        FROM  (\r\n            SELECT");
            viewString.Append(" \r\n                T.DeviceId AS Device_DeviceId, \r\n                T.ExternalId");
            viewString.Append(" AS Device_ExternalId, \r\n                T.Description AS Device_Description, \r\n");
            viewString.Append("                T.Metadata AS Device_Metadata, \r\n                T.Type AS Devic");
            viewString.Append("e_Type, \r\n                T.Lat AS Device_Lat, \r\n                T.Long AS Devic");
            viewString.Append("e_Long, \r\n                T.Altitude AS Device_Altitude, \r\n                T.Loc");
            viewString.Append("ationDescription AS Device_LocationDescription, \r\n                T.CameraGuid A");
            viewString.Append("S Device_CameraGuid, \r\n                T.NvrId AS Device_NvrId, \r\n              ");
            viewString.Append("  T.SiteId AS Device_SiteId, \r\n                T.ActiveAlert AS Device_ActiveAle");
            viewString.Append("rt, \r\n                T.HasPvAnalytics AS Device_HasPvAnalytics, \r\n             ");
            viewString.Append("   T.HasSzAnalytics AS Device_HasSzAnalytics, \r\n                T.HasAbAnalytics");
            viewString.Append(" AS Device_HasAbAnalytics, \r\n                T.InterfaceId AS Device_InterfaceId");
            viewString.Append(", \r\n                T.IsMovable AS Device_IsMovable, \r\n                T.Name AS");
            viewString.Append(" Device_Name, \r\n                True AS _from1\r\n            FROM CentralDBModelS");
            viewString.Append("toreContainer.Device AS T) AS T1\r\n            LEFT OUTER JOIN (\r\n            SEL");
            viewString.Append("ECT \r\n                T.CameraId AS Device_DeviceId, \r\n                T.FPS AS ");
            viewString.Append("NvrCamera_FPS, \r\n                T.AnalyticAlgorithmTypeId AS NvrCamera_Analytic");
            viewString.Append("AlgorithmTypeId, \r\n                T.Version AS NvrCamera_Version, \r\n           ");
            viewString.Append("     T.MaxBlobSize AS NvrCamera_MaxBlobSize, \r\n                T.MinBlobSize AS ");
            viewString.Append("NvrCamera_MinBlobSize, \r\n                T.AlarmDelay AS NvrCamera_AlarmDelay, \r");
            viewString.Append("\n                T.UpdateRate AS NvrCamera_UpdateRate, \r\n                T.Width");
            viewString.Append(" AS NvrCamera_Width, \r\n                T.Height AS NvrCamera_Height, \r\n         ");
            viewString.Append("       T.ZoneRows AS NvrCamera_ZoneRows, \r\n                T.ZoneColumns AS NvrC");
            viewString.Append("amera_ZoneColumns, \r\n                T.ZoneData AS NvrCamera_ZoneData, \r\n       ");
            viewString.Append("         T.AnalyticsEventTemplateId AS NvrCamera_AnalyticsEventTemplateId, \r\n   ");
            viewString.Append("             T.IsPtz AS NvrCamera_IsPtz, \r\n                T.CameraIp AS NvrCame");
            viewString.Append("ra_CameraIp, \r\n                T.LineStart AS NvrCamera_LineStart, \r\n           ");
            viewString.Append("     T.LineEnd AS NvrCamera_LineEnd, \r\n                T.DirectionFlag AS NvrCam");
            viewString.Append("era_DirectionFlag, \r\n                T.CameraUrl AS NvrCamera_CameraUrl, \r\n     ");
            viewString.Append("           T.CameraPort AS NvrCamera_CameraPort, \r\n                T.CamUser AS ");
            viewString.Append("NvrCamera_CamUser, \r\n                T.CamPassword AS NvrCamera_CamPassword, \r\n ");
            viewString.Append("               T.MaxBlobWidth AS NvrCamera_MaxBlobWidth, \r\n                T.Max");
            viewString.Append("BlobHeight AS NvrCamera_MaxBlobHeight, \r\n                T.MinBlobWidth AS NvrCa");
            viewString.Append("mera_MinBlobWidth, \r\n                T.MinBlobHeight AS NvrCamera_MinBlobHeight,");
            viewString.Append(" \r\n                T.CameraType AS NvrCamera_CameraType, \r\n                T.Ana");
            viewString.Append("lyticsServerIp AS NvrCamera_AnalyticsServerIp, \r\n                T.Lane1 AS NvrC");
            viewString.Append("amera_Lane1, \r\n                T.Lane2 AS NvrCamera_Lane2, \r\n                T.L");
            viewString.Append("ane3 AS NvrCamera_Lane3, \r\n                T.NoOfLens AS NvrCamera_NoOfLens, \r\n ");
            viewString.Append("               T.ChanelNo AS NvrCamera_ChanelNo, \r\n                T.IsEdgeAnaly");
            viewString.Append("tics AS NvrCamera_IsEdgeAnalytics, \r\n                True AS _from0\r\n           ");
            viewString.Append(" FROM CentralDBModelStoreContainer.NvrCamera AS T) AS T2\r\n            ON T1.Devi");
            viewString.Append("ce_DeviceId = T2.Device_DeviceId\r\n    ) AS T3");
    ...
    SELECT VALUE -- Constructing IncidentReportCamera
        [CentralDBModel.IncidentReportCamera](T1.IncidentReportCamera_IncidentReportCamerasId, T1.IncidentReportCamera_IncidentReportId, T1.IncidentReportCamera_CameraId, T1.IncidentReportCamera_Sequence, T1.IncidentReportCamera_PlyDateTime)
    FROM (
        SELECT 
            T.IncidentReportCamerasId AS IncidentReportCamera_IncidentReportCamerasId, 
            T.IncidentReportId AS IncidentReportCamera_IncidentReportId, 
    ...
    SELECT VALUE -- Constructing IncidentReportStatus
        [CentralDBModel.IncidentReportStatus](T1.IncidentReportStatus_IncidentReportStatusId, T1.IncidentReportStatus_IncidentReportId, T1.IncidentReportStatus_ChangeDate, T1.IncidentReportStatus_Status, T1.IncidentReportStatus_Notes, T1.IncidentReportStatus_UpdatedBy)
    FROM (
        SELECT 
            T.IncidentReportStatusId AS IncidentReportStatus_IncidentReportStatusId, 
            T.IncidentReportId AS IncidentReportStatus_IncidentReportId, 
    ...
    SELECT VALUE -- Constructing ResourcesData
        [CentralDBModel.ResourcesData](T1.ResourcesData_Id, T1.ResourcesData_Data, T1.ResourcesData_EvidenceType)
    FROM (
        SELECT 
            T.Id AS ResourcesData_Id, 
            T.Data AS ResourcesData_Data, 
    ...
    SELECT VALUE -- Constructing tbluserassigmentlog
        [CentralDBModel.Store.tbluserassigmentlog](T1.tbluserassigmentlog_ID, T1.tbluserassigmentlog_AlertID, T1.tbluserassigmentlog_ExistingMembershipID, T1.tbluserassigmentlog_NewMembershipID, T1.tbluserassigmentlog_updatedatetime)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing tbluserassigmentlog
        [CentralDBModel.tbluserassigmentlog](T1.tbluserassigmentlog_ID, T1.tbluserassigmentlog_AlertID, T1.tbluserassigmentlog_ExistingMembershipID, T1.tbluserassigmentlog_NewMembershipID, T1.tbluserassigmentlog_updatedatetime)
    FROM (
        SELECT 
            T.ID AS tbluserassigmentlog_ID, 
            T.AlertID AS tbluserassigmentlog_AlertID, 
    ...
    SELECT VALUE -- Constructing tblCameraStatus
        [CentralDBModel.Store.tblCameraStatus](T1.tblCameraStatus_CameraStatusID, T1.tblCameraStatus_DeviceID, T1.tblCameraStatus_Status, T1.tblCameraStatus_Remarks)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing tblCameraStatus
        [CentralDBModel.tblCameraStatus](T1.tblCameraStatus_CameraStatusID, T1.tblCameraStatus_DeviceID, T1.tblCameraStatus_Status, T1.tblCameraStatus_Remarks)
    FROM (
        SELECT 
            T.CameraStatusID AS tblCameraStatus_CameraStatusID, 
            T.DeviceID AS tblCameraStatus_DeviceID, 
    ...
    SELECT VALUE -- Constructing tblANPRMaster
        [CentralDBModel.Store.tblANPRMaster](T1.tblANPRMaster_ANPRID, T1.tblANPRMaster_DeviceID, T1.tblANPRMaster_ANPRCameraName, T1.tblANPRMaster_appkey)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing tblANPRMaster
        [CentralDBModel.tblANPRMaster](T1.tblANPRMaster_ANPRID, T1.tblANPRMaster_DeviceID, T1.tblANPRMaster_ANPRCameraName, T1.tblANPRMaster_appkey)
    FROM (
        SELECT 
            T.ANPRID AS tblANPRMaster_ANPRID, 
            T.DeviceID AS tblANPRMaster_DeviceID, 
        ...
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.tblANPRTransDetails
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView241()
        {
            ...
            viewString.Append("\r\n    SELECT VALUE -- Constructing tblANPRTransDetails\r\n        [CentralDBModel.");
            viewString.Append("Store.tblANPRTransDetails](T1.[tblANPRTransDetails.U_Id], T1.tblANPRTransDetails");
            viewString.Append("_AppKey, T1.tblANPRTransDetails_CamName, T1.tblANPRTransDetails_No, T1.tblANPRTr");
            viewString.Append("ansDetails_LPImage, T1.tblANPRTransDetails_RecNum, T1.tblANPRTransDetails_DateTi");
            viewString.Append("me, T1.tblANPRTransDetails_Direction, T1.tblANPRTransDetails_RegName, T1.tblANPR");
            viewString.Append("TransDetails_DriverImage, T1.tblANPRTransDetails_ContactNum, T1.tblANPRTransDeta");
            viewString.Append("ils_AccessStatus, T1.tblANPRTransDetails_Validated, T1.tblANPRTransDetails_Extra");
            viewString.Append("ctedLPImage, T1.tblANPRTransDetails_DriverImagePath, T1.tblANPRTransDetails_NPIm");
            viewString.Append("agePath, T1.tblANPRTransDetails_VehicleType, T1.tblANPRTransDetails_VehicleMake,");
            viewString.Append(" T1.tblANPRTransDetails_Confidence, T1.tblANPRTransDetails_AlertID)\r\n    FROM (\r");
            viewString.Append("\n        SELECT \r\n            T.U_Id AS [tblANPRTransDetails.U_Id], \r\n          ");
            viewString.Append("  T.AppKey AS tblANPRTransDetails_AppKey, \r\n            T.CamName AS tblANPRTran");
            viewString.Append("sDetails_CamName, \r\n            T.No AS tblANPRTransDetails_No, \r\n            T.");
            viewString.Append("LPImage AS tblANPRTransDetails_LPImage, \r\n            T.RecNum AS tblANPRTransDe");
            viewString.Append("tails_RecNum, \r\n            T.DateTime AS tblANPRTransDetails_DateTime, \r\n      ");
            viewString.Append("      T.Direction AS tblANPRTransDetails_Direction, \r\n            T.RegName AS t");
            viewString.Append("blANPRTransDetails_RegName, \r\n            T.DriverImage AS tblANPRTransDetails_D");
            viewString.Append("riverImage, \r\n            T.ContactNum AS tblANPRTransDetails_ContactNum, \r\n    ");
            viewString.Append("        T.AccessStatus AS tblANPRTransDetails_AccessStatus, \r\n            T.Vali");
            viewString.Append("dated AS tblANPRTransDetails_Validated, \r\n            T.ExtractedLPImage AS tblA");
            viewString.Append("NPRTransDetails_ExtractedLPImage, \r\n            T.DriverImagePath AS tblANPRTran");
            viewString.Append("sDetails_DriverImagePath, \r\n            T.NPImagePath AS tblANPRTransDetails_NPI");
            viewString.Append("magePath, \r\n            T.VehicleType AS tblANPRTransDetails_VehicleType, \r\n    ");
            viewString.Append("        T.VehicleMake AS tblANPRTransDetails_VehicleMake, \r\n            T.Confid");
            viewString.Append("ence AS tblANPRTransDetails_Confidence, \r\n            T.AlertID AS tblANPRTransD");
            viewString.Append("etails_AlertID, \r\n            True AS _from0\r\n        FROM Entities.tblANPRTrans");
            viewString.Append("Details AS T\r\n    ) AS T1");
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.tblANPRTransDetails", viewString.ToString());
        }
        
        /// <Summary>
        /// return view for Entities.tblANPRTransDetails
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView242()
        {
            ...
            viewString.Append("\r\n    SELECT VALUE -- Constructing tblANPRTransDetails\r\n        [CentralDBModel.");
            viewString.Append("tblANPRTransDetails](T1.[tblANPRTransDetails.U_Id], T1.tblANPRTransDetails_AppKe");
            viewString.Append("y, T1.tblANPRTransDetails_CamName, T1.tblANPRTransDetails_No, T1.tblANPRTransDet");
            viewString.Append("ails_LPImage, T1.tblANPRTransDetails_RecNum, T1.tblANPRTransDetails_DateTime, T1");
            viewString.Append(".tblANPRTransDetails_Direction, T1.tblANPRTransDetails_RegName, T1.tblANPRTransD");
            viewString.Append("etails_DriverImage, T1.tblANPRTransDetails_ContactNum, T1.tblANPRTransDetails_Ac");
            viewString.Append("cessStatus, T1.tblANPRTransDetails_Validated, T1.tblANPRTransDetails_ExtractedLP");
            viewString.Append("Image, T1.tblANPRTransDetails_DriverImagePath, T1.tblANPRTransDetails_NPImagePat");
            viewString.Append("h, T1.tblANPRTransDetails_VehicleType, T1.tblANPRTransDetails_VehicleMake, T1.tb");
            viewString.Append("lANPRTransDetails_Confidence, T1.tblANPRTransDetails_AlertID)\r\n    FROM (\r\n     ");
            viewString.Append("   SELECT \r\n            T.U_Id AS [tblANPRTransDetails.U_Id], \r\n            T.Ap");
            viewString.Append("pKey AS tblANPRTransDetails_AppKey, \r\n            T.CamName AS tblANPRTransDetai");
            viewString.Append("ls_CamName, \r\n            T.No AS tblANPRTransDetails_No, \r\n            T.LPImag");
            viewString.Append("e AS tblANPRTransDetails_LPImage, \r\n            T.RecNum AS tblANPRTransDetails_");
            viewString.Append("RecNum, \r\n            T.DateTime AS tblANPRTransDetails_DateTime, \r\n            ");
            viewString.Append("T.Direction AS tblANPRTransDetails_Direction, \r\n            T.RegName AS tblANPR");
            viewString.Append("TransDetails_RegName, \r\n            T.DriverImage AS tblANPRTransDetails_DriverI");
            viewString.Append("mage, \r\n            T.ContactNum AS tblANPRTransDetails_ContactNum, \r\n          ");
            viewString.Append("  T.AccessStatus AS tblANPRTransDetails_AccessStatus, \r\n            T.Validated ");
            viewString.Append("AS tblANPRTransDetails_Validated, \r\n            T.ExtractedLPImage AS tblANPRTra");
            viewString.Append("nsDetails_ExtractedLPImage, \r\n            T.DriverImagePath AS tblANPRTransDetai");
            viewString.Append("ls_DriverImagePath, \r\n            T.NPImagePath AS tblANPRTransDetails_NPImagePa");
            viewString.Append("th, \r\n            T.VehicleType AS tblANPRTransDetails_VehicleType, \r\n          ");
            viewString.Append("  T.VehicleMake AS tblANPRTransDetails_VehicleMake, \r\n            T.Confidence A");
            viewString.Append("S tblANPRTransDetails_Confidence, \r\n            T.AlertID AS tblANPRTransDetails");
            viewString.Append("_AlertID, \r\n            True AS _from0\r\n        FROM CentralDBModelStoreContaine");
            viewString.Append("r.tblANPRTransDetails AS T\r\n    ) AS T1");
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.tblANPRTransDetails", viewString.ToString());
        }
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.tblcustomeremergencycontact
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView295()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.tblcustomeremergencycontact", @"
    SELECT VALUE -- Constructing tblcustomeremergencycontact
        [CentralDBModel.Store.tblcustomeremergencycontact](T1.tblcustomeremergencycontact_ID, T1.tblcustomeremergencycontact_SiteID, T1.tblcustomeremergencycontact_Title, T1.tblcustomeremergencycontact_contactname, T1.tblcustomeremergencycontact_contactno, T1.tblcustomeremergencycontact_contactemailid, T1.tblcustomeremergencycontact_contactrelation, T1.tblcustomeremergencycontact_ownershipinfo, T1.tblcustomeremergencycontact_deletionflag)
    FROM (
        SELECT 
            T.ID AS tblcustomeremergencycontact_ID, 
            T.SiteID AS tblcustomeremergencycontact_SiteID, 
            T.Title AS tblcustomeremergencycontact_Title, 
            T.contactname AS tblcustomeremergencycontact_contactname, 
            T.contactno AS tblcustomeremergencycontact_contactno, 
            T.contactemailid AS tblcustomeremergencycontact_contactemailid, 
            T.contactrelation AS tblcustomeremergencycontact_contactrelation, 
            T.ownershipinfo AS tblcustomeremergencycontact_ownershipinfo, 
            T.deletionflag AS tblcustomeremergencycontact_deletionflag, 
            True AS _from0
        FROM Entities.tblcustomeremergencycontact AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for Entities.tblcustomeremergencycontact
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView296()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.tblcustomeremergencycontact", @"
    SELECT VALUE -- Constructing tblcustomeremergencycontact
        [CentralDBModel.tblcustomeremergencycontact](T1.tblcustomeremergencycontact_ID, T1.tblcustomeremergencycontact_SiteID, T1.tblcustomeremergencycontact_Title, T1.tblcustomeremergencycontact_contactname, T1.tblcustomeremergencycontact_contactno, T1.tblcustomeremergencycontact_contactemailid, T1.tblcustomeremergencycontact_contactrelation, T1.tblcustomeremergencycontact_ownershipinfo, T1.tblcustomeremergencycontact_deletionflag)
    FROM (
        SELECT 
            T.ID AS tblcustomeremergencycontact_ID, 
            T.SiteID AS tblcustomeremergencycontact_SiteID, 
            ...
            T.deletionflag AS tblcustomeremergencycontact_deletionflag, 
            True AS _from0
        FROM CentralDBModelStoreContainer.tblcustomeremergencycontact AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.ObjectsAssociation
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView297()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.ObjectsAssociation", @"
    SELECT VALUE -- Constructing ObjectsAssociation
        [CentralDBModel.Store.ObjectsAssociation](T1.ObjectsAssociation_ObjectsAssociationId, T1.ObjectsAssociation_Object1Identity, T1.ObjectsAssociation_Object2Identity, T1.ObjectsAssociation_ObjectTypeId)
    FROM (
        SELECT 
            T.ObjectsAssociationId AS ObjectsAssociation_ObjectsAssociationId, 
            T.Object1Identity AS ObjectsAssociation_Object1Identity, 
            T.Object2Identity AS ObjectsAssociation_Object2Identity, 
            T.ObjectTypeId AS ObjectsAssociation_ObjectTypeId, 
            True AS _from0
        FROM Entities.ObjectsAssociation AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.ObjectType
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView298()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.ObjectType", @"
    SELECT VALUE -- Constructing ObjectType
        [CentralDBModel.Store.ObjectType](T1.ObjectType_ObjectTypeId, T1.ObjectType_Name)
    FROM (
        SELECT 
            T.ObjectTypeId AS ObjectType_ObjectTypeId, 
            T.Name AS ObjectType_Name, 
            True AS _from0
        FROM Entities.ObjectType AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for Entities.ObjectsAssociation
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView299()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.ObjectsAssociation", @"
    SELECT VALUE -- Constructing ObjectsAssociation
        [CentralDBModel.ObjectsAssociation](T1.ObjectsAssociation_ObjectsAssociationId, T1.ObjectsAssociation_Object1Identity, T1.ObjectsAssociation_Object2Identity, T1.ObjectsAssociation_ObjectTypeId)
    FROM (
        SELECT 
            T.ObjectsAssociationId AS ObjectsAssociation_ObjectsAssociationId, 
            T.Object1Identity AS ObjectsAssociation_Object1Identity, 
            ...
            T.ObjectTypeId AS ObjectsAssociation_ObjectTypeId, 
            True AS _from0
        FROM CentralDBModelStoreContainer.ObjectsAssociation AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for Entities.ObjectType
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView300()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.ObjectType", @"
    SELECT VALUE -- Constructing ObjectType
        [CentralDBModel.ObjectType](T1.ObjectType_ObjectTypeId, T1.ObjectType_Name)
    FROM (
        SELECT 
            T.ObjectTypeId AS ObjectType_ObjectTypeId, 
            T.Name AS ObjectType_Name, 
            True AS _from0
        FROM CentralDBModelStoreContainer.ObjectType AS T
    ) AS T1");
        }
