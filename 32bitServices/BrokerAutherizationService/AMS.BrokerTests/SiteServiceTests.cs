...
using AMS.Broker.AutherizationServiceTests.SitesWcfService;
using AutoMapper;
...
namespace AMS.Broker.AutherizationServiceTests
{
    ...
    public class SiteServiceTests : BaseTest
    {
        ...
        private static AMS.Broker.Contracts.Services.ISitesSetOperationService _sitesServiceSet;
        ...
        private static IAccountsSetOperationService _accountsServiceSet;
        ...
        {            
            ...
            AutoMapperConfiguration.CreateAllMaps();
            _sitesService = null;// new SitesService();
        ...
        */
        ...
        public void CRUD_BBoxPoint()
        {
            ...
            //Add
            var addResult = _sitesServiceSet.AddBBoxPoint(bboxPoint1, site);
            ...
            var updateResult = _sitesServiceSet.UpdateBBoxPoint(bboxPoint1);
            Assert.IsTrue(updateResult.Lat == -33);

            //Delete
            var deleteResult = _sitesServiceSet.DeleteBBoxPoint(updateResult.BBoxPointId);
        ...
        public void CRUD_Site()
        {
            ...
            var site = CreateSiteDto();
            var siteType = _sitesService.GetSiteTypes(null)[0];
            var parentSite = _sitesService.GetSites("")[0];
            var bboxPoints = new List<BBoxPointDto>() {CreateBBoxPointDto(), CreateBBoxPointDto()};

            //Add
            var addResult = _sitesServiceSet.AddSite(site, siteType, parentSite, null, null, bboxPoints,null,null);
            Assert.IsTrue(addResult.BBoxPointCollection.Count == 2);


            //Update
            addResult.Description = newDescription;
            var editResult = _sitesServiceSet.UpdateSite(addResult,null,null);

            Assert.IsTrue(editResult.Description == newDescription);

            //Read
            var readResult = _sitesService.GetSite(editResult.SiteId,null);
            ...
            {
                _sitesServiceSet.DeleteBBoxPoint(bBoxPointDto.BBoxPointId);
            }
        ...
        public void CRUD_SiteType()
        {
            ...
            //Add
            var addResult = _sitesServiceSet.AddSiteType(siteType);
            ...
            var editResult = _sitesServiceSet.UpdateSiteType(readResult);

            Assert.IsTrue(editResult.Name == newName);

            //Delete
            var deleteResult = _sitesServiceSet.DeleteSiteType(editResult.SiteTypeId);
