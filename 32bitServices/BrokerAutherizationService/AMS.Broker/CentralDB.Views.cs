...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets87AD06AD89A529C0135C5E83BD9231AAE483F342EB825B087F76AFD91C28B3B4))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets87AD06AD89A529C0135C5E83BD9231AAE483F342EB825B087F76AFD91C28B3B4 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets87AD06AD89A529C0135C5E83BD9231AAE483F342EB825B087F76AFD91C28B3B4()
        {
            this.EdmEntityContainerName = "Entities";
            this.StoreEntityContainerName = "CentralDBModelStoreContainer";
            this.HashOverMappingClosure = "5a660cee57660df64eb132357493340b3998cf9e3998e83c710fe2b9f9738ec4";
            this.HashOverAllExtentViews = "45d885885ffb9cf3bf639530974d8fc9614e318459b9707868d578db1b508fc6";
            this.ViewCount = 303;
        }
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(4411);
            ...
            viewString.Append("1.NvrCamera_Mediaurl, T1.NvrCamera_MediaType)\r\n    FROM (\r\n        SELECT \r\n    ");
            viewString.Append("        T.DeviceId AS NvrCamera_CameraId, \r\n            TREAT(T AS [CentralDBMod");
            viewString.Append("el.NvrCamera]).FPS AS NvrCamera_FPS, \r\n            TREAT(T AS [CentralDBModel.Nv");
            viewString.Append("rCamera]).AnalyticAlgorithmTypeId AS NvrCamera_AnalyticAlgorithmTypeId, \r\n      ");
            viewString.Append("      TREAT(T AS [CentralDBModel.NvrCamera]).Version AS NvrCamera_Version, \r\n   ");
            viewString.Append("         TREAT(T AS [CentralDBModel.NvrCamera]).MaxBlobSize AS NvrCamera_MaxBlob");
            viewString.Append("Size, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).MinBlobSize AS NvrCam");
            viewString.Append("era_MinBlobSize, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).AlarmDelay");
            viewString.Append(" AS NvrCamera_AlarmDelay, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).U");
            viewString.Append("pdateRate AS NvrCamera_UpdateRate, \r\n            TREAT(T AS [CentralDBModel.NvrC");
            viewString.Append("amera]).Width AS NvrCamera_Width, \r\n            TREAT(T AS [CentralDBModel.NvrCa");
            viewString.Append("mera]).Height AS NvrCamera_Height, \r\n            TREAT(T AS [CentralDBModel.NvrC");
            viewString.Append("amera]).ZoneRows AS NvrCamera_ZoneRows, \r\n            TREAT(T AS [CentralDBModel");
            viewString.Append(".NvrCamera]).ZoneColumns AS NvrCamera_ZoneColumns, \r\n            TREAT(T AS [Cen");
            viewString.Append("tralDBModel.NvrCamera]).ZoneData AS NvrCamera_ZoneData, \r\n            TREAT(T AS");
            viewString.Append(" [CentralDBModel.NvrCamera]).AnalyticsEventTemplateId AS NvrCamera_AnalyticsEven");
            viewString.Append("tTemplateId, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).IsPtz AS NvrCa");
            viewString.Append("mera_IsPtz, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).CameraIp AS Nvr");
            viewString.Append("Camera_CameraIp, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).LineStart ");
            viewString.Append("AS NvrCamera_LineStart, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Lin");
            viewString.Append("eEnd AS NvrCamera_LineEnd, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).");
            viewString.Append("DirectionFlag AS NvrCamera_DirectionFlag, \r\n            TREAT(T AS [CentralDBMod");
            viewString.Append("el.NvrCamera]).CameraUrl AS NvrCamera_CameraUrl, \r\n            TREAT(T AS [Centr");
            viewString.Append("alDBModel.NvrCamera]).CameraPort AS NvrCamera_CameraPort, \r\n            TREAT(T ");
            viewString.Append("AS [CentralDBModel.NvrCamera]).CamUser AS NvrCamera_CamUser, \r\n            TREAT");
            viewString.Append("(T AS [CentralDBModel.NvrCamera]).CamPassword AS NvrCamera_CamPassword, \r\n      ");
            viewString.Append("      TREAT(T AS [CentralDBModel.NvrCamera]).MaxBlobWidth AS NvrCamera_MaxBlobWi");
            viewString.Append("dth, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).MaxBlobHeight AS NvrCa");
            viewString.Append("mera_MaxBlobHeight, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).MinBlob");
            viewString.Append("Width AS NvrCamera_MinBlobWidth, \r\n            TREAT(T AS [CentralDBModel.NvrCam");
            viewString.Append("era]).MinBlobHeight AS NvrCamera_MinBlobHeight, \r\n            TREAT(T AS [Centra");
            viewString.Append("lDBModel.NvrCamera]).CameraType AS NvrCamera_CameraType, \r\n            TREAT(T A");
            viewString.Append("S [CentralDBModel.NvrCamera]).AnalyticsServerIp AS NvrCamera_AnalyticsServerIp, ");
            viewString.Append("\r\n            TREAT(T AS [CentralDBModel.NvrCamera]).Lane1 AS NvrCamera_Lane1, \r");
            viewString.Append("\n            TREAT(T AS [CentralDBModel.NvrCamera]).Lane2 AS NvrCamera_Lane2, \r\n");
            viewString.Append("            TREAT(T AS [CentralDBModel.NvrCamera]).Lane3 AS NvrCamera_Lane3, \r\n ");
            viewString.Append("           TREAT(T AS [CentralDBModel.NvrCamera]).NoOfLens AS NvrCamera_NoOfLens");
            viewString.Append(", \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).ChanelNo AS NvrCamera_Cha");
            viewString.Append("nelNo, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).IsEdgeAnalytics AS N");
            viewString.Append("vrCamera_IsEdgeAnalytics, \r\n            TREAT(T AS [CentralDBModel.NvrCamera]).M");
            viewString.Append("ediaurl AS NvrCamera_Mediaurl, \r\n            TREAT(T AS [CentralDBModel.NvrCamer");
            viewString.Append("a]).MediaType AS NvrCamera_MediaType, \r\n            True AS _from0\r\n        FROM");
            viewString.Append(" Entities.Device AS T\r\n        WHERE T IS OF (ONLY [CentralDBModel.NvrCamera])\r\n");
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.aspnet_Membership
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView77()
        {
            ...
            viewString.Append("ore.aspnet_Membership](T1.[aspnet_Membership.ApplicationId], T1.[aspnet_Membersh");
            viewString.Append("ip.UserId], T1.[aspnet_Membership.Password], T1.[aspnet_Membership.PasswordForma");
            viewString.Append("t], T1.[aspnet_Membership.PasswordSalt], T1.[aspnet_Membership.MobilePIN], T1.[a");
            viewString.Append("spnet_Membership.Email], T1.[aspnet_Membership.LoweredEmail], T1.[aspnet_Members");
            viewString.Append("hip.PasswordQuestion], T1.[aspnet_Membership.PasswordAnswer], T1.[aspnet_Members");
            viewString.Append("hip.IsApproved], T1.[aspnet_Membership.IsLockedOut], T1.[aspnet_Membership.Creat");
            viewString.Append("eDate], T1.[aspnet_Membership.LastLoginDate], T1.[aspnet_Membership.LastPassword");
            viewString.Append("ChangedDate], T1.[aspnet_Membership.LastLockoutDate], T1.[aspnet_Membership.Fail");
            viewString.Append("edPasswordAttemptCount], T1.[aspnet_Membership.FailedPasswordAttemptWindowStart]");
            viewString.Append(", T1.[aspnet_Membership.FailedPasswordAnswerAttemptCount], T1.[aspnet_Membership");
            viewString.Append(".FailedPasswordAnswerAttemptWindowStart], T1.[aspnet_Membership.Comment], T1.[as");
            viewString.Append("pnet_Membership.PasswordValidity])\r\n    FROM (\r\n        SELECT \r\n            T.A");
            viewString.Append("pplicationId AS [aspnet_Membership.ApplicationId], \r\n            T.UserId AS [as");
            viewString.Append("pnet_Membership.UserId], \r\n            T.Password AS [aspnet_Membership.Password");
            viewString.Append("], \r\n            T.PasswordFormat AS [aspnet_Membership.PasswordFormat], \r\n     ");
            viewString.Append("       T.PasswordSalt AS [aspnet_Membership.PasswordSalt], \r\n            T.Mobil");
            viewString.Append("ePIN AS [aspnet_Membership.MobilePIN], \r\n            T.Email AS [aspnet_Membersh");
            viewString.Append("ip.Email], \r\n            T.LoweredEmail AS [aspnet_Membership.LoweredEmail], \r\n ");
            viewString.Append("           T.PasswordQuestion AS [aspnet_Membership.PasswordQuestion], \r\n       ");
            viewString.Append("     T.PasswordAnswer AS [aspnet_Membership.PasswordAnswer], \r\n            T.IsA");
            viewString.Append("pproved AS [aspnet_Membership.IsApproved], \r\n            T.IsLockedOut AS [aspne");
            viewString.Append("t_Membership.IsLockedOut], \r\n            T.CreateDate AS [aspnet_Membership.Crea");
            viewString.Append("teDate], \r\n            T.LastLoginDate AS [aspnet_Membership.LastLoginDate], \r\n ");
            viewString.Append("           T.LastPasswordChangedDate AS [aspnet_Membership.LastPasswordChangedDa");
            viewString.Append("te], \r\n            T.LastLockoutDate AS [aspnet_Membership.LastLockoutDate], \r\n ");
            viewString.Append("           T.FailedPasswordAttemptCount AS [aspnet_Membership.FailedPasswordAtte");
            viewString.Append("mptCount], \r\n            T.FailedPasswordAttemptWindowStart AS [aspnet_Membershi");
            viewString.Append("p.FailedPasswordAttemptWindowStart], \r\n            T.FailedPasswordAnswerAttempt");
            viewString.Append("Count AS [aspnet_Membership.FailedPasswordAnswerAttemptCount], \r\n            T.F");
            viewString.Append("ailedPasswordAnswerAttemptWindowStart AS [aspnet_Membership.FailedPasswordAnswer");
            viewString.Append("AttemptWindowStart], \r\n            T.Comment AS [aspnet_Membership.Comment], \r\n ");
            viewString.Append("           T.PasswordValidity AS [aspnet_Membership.PasswordValidity], \r\n       ");
            viewString.Append("     True AS _from0\r\n        FROM Entities.aspnet_Membership AS T\r\n    ) AS T1");
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.aspnet_Membership", viewString.ToString());
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView84()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.Alert", "\r\n    SELECT VALUE -- Constructing Alert\r\n        [CentralDBModel.Alert](T1.Alert" +
                    ...
                    "Context, T1.Alert_AlertAckDateTime, T1.Alert_AlertCloseDateTime)\r\n    FROM (\r\n  " +
                    "      SELECT \r\n            T.AlertId AS Alert_AlertId, \r\n            T.Identifie" +
                    "r AS Alert_Identifier, \r\n            T.Sender AS Alert_Sender, \r\n            T.S" +
                    "ent AS Alert_Sent, \r\n            T.StatusId AS Alert_StatusId, \r\n            T.M" +
                    "essageTypeId AS Alert_MessageTypeId, \r\n            T.ScopeId AS Alert_ScopeId, \r" +
                    "\n            T.Source AS Alert_Source, \r\n            T.Restriction AS Alert_Rest" +
                    "riction, \r\n            T.Addresses AS Alert_Addresses, \r\n            T.Code AS A" +
                    "lert_Code, \r\n            T.Note AS Alert_Note, \r\n            T.References AS Ale" +
                    "rt_References, \r\n            T.Incidents AS Alert_Incidents, \r\n            T.Dev" +
                    "iceId AS Alert_DeviceId, \r\n            T.ReceivedDateTime AS Alert_ReceivedDateT" +
                    "ime, \r\n            T.MembershipUserId AS Alert_MembershipUserId, \r\n            T" +
                    ".AlertOwner AS Alert_AlertOwner, \r\n            T.Alertzone AS Alert_Alertzone, \r" +
                    "\n            T.EventID AS Alert_EventID, \r\n            T.AlertContext AS Alert_A" +
                    "lertContext, \r\n            T.AlertAckDateTime AS Alert_AlertAckDateTime, \r\n     " +
                    "       T.AlertCloseDateTime AS Alert_AlertCloseDateTime, \r\n            True AS _" +
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(6645);
            viewString.Append("\r\n    SELECT VALUE -- Constructing Device\r\n        CASE\r\n            WHEN NOT(T3");
            ...
            viewString.Append("NvrCamera_MediaType)\r\n        END\r\n    FROM (\r\n        SELECT T1.Device_DeviceId");
            viewString.Append(", T1.Device_ExternalId, T1.Device_Description, T1.Device_Metadata, T1.Device_Typ");
            viewString.Append("e, T1.Device_Lat, T1.Device_Long, T1.Device_Altitude, T1.Device_LocationDescript");
            viewString.Append("ion, T1.Device_CameraGuid, T1.Device_NvrId, T1.Device_SiteId, T1.Device_ActiveAl");
            viewString.Append("ert, T1.Device_HasPvAnalytics, T1.Device_HasSzAnalytics, T1.Device_HasAbAnalytic");
            viewString.Append("s, T1.Device_InterfaceId, T1.Device_IsMovable, T1.Device_Name, T2.NvrCamera_FPS,");
            viewString.Append(" T2.NvrCamera_AnalyticAlgorithmTypeId, T2.NvrCamera_Version, T2.NvrCamera_MaxBlo");
            viewString.Append("bSize, T2.NvrCamera_MinBlobSize, T2.NvrCamera_AlarmDelay, T2.NvrCamera_UpdateRat");
            viewString.Append("e, T2.NvrCamera_Width, T2.NvrCamera_Height, T2.NvrCamera_ZoneRows, T2.NvrCamera_");
            viewString.Append("ZoneColumns, T2.NvrCamera_ZoneData, T2.NvrCamera_AnalyticsEventTemplateId, T2.Nv");
            viewString.Append("rCamera_IsPtz, T2.NvrCamera_CameraIp, T2.NvrCamera_LineStart, T2.NvrCamera_LineE");
            viewString.Append("nd, T2.NvrCamera_DirectionFlag, T2.NvrCamera_CameraUrl, T2.NvrCamera_CameraPort,");
            viewString.Append(" T2.NvrCamera_CamUser, T2.NvrCamera_CamPassword, T2.NvrCamera_MaxBlobWidth, T2.N");
            viewString.Append("vrCamera_MaxBlobHeight, T2.NvrCamera_MinBlobWidth, T2.NvrCamera_MinBlobHeight, T");
            viewString.Append("2.NvrCamera_CameraType, T2.NvrCamera_AnalyticsServerIp, T2.NvrCamera_Lane1, T2.N");
            viewString.Append("vrCamera_Lane2, T2.NvrCamera_Lane3, T2.NvrCamera_NoOfLens, T2.NvrCamera_ChanelNo");
            viewString.Append(", T2.NvrCamera_IsEdgeAnalytics, T2.NvrCamera_Mediaurl, T2.NvrCamera_MediaType, (");
            ...
            viewString.Append("             True AS _from0\r\n            FROM CentralDBModelStoreContainer.NvrCa");
            viewString.Append("mera AS T) AS T2\r\n            ON T1.Device_DeviceId = T2.Device_DeviceId\r\n    ) ");
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for Entities.aspnet_Membership
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView156()
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(2732);
            viewString.Append("\r\n    SELECT VALUE -- Constructing aspnet_Membership\r\n        [CentralDBModel.as");
            viewString.Append("pnet_Membership](T1.[aspnet_Membership.ApplicationId], T1.[aspnet_Membership.Use");
            viewString.Append("rId], T1.[aspnet_Membership.Password], T1.[aspnet_Membership.PasswordFormat], T1");
            viewString.Append(".[aspnet_Membership.PasswordSalt], T1.[aspnet_Membership.MobilePIN], T1.[aspnet_");
            viewString.Append("Membership.Email], T1.[aspnet_Membership.LoweredEmail], T1.[aspnet_Membership.Pa");
            viewString.Append("sswordQuestion], T1.[aspnet_Membership.PasswordAnswer], T1.[aspnet_Membership.Is");
            viewString.Append("Approved], T1.[aspnet_Membership.IsLockedOut], T1.[aspnet_Membership.CreateDate]");
            viewString.Append(", T1.[aspnet_Membership.LastLoginDate], T1.[aspnet_Membership.LastPasswordChange");
            viewString.Append("dDate], T1.[aspnet_Membership.LastLockoutDate], T1.[aspnet_Membership.FailedPass");
            viewString.Append("wordAttemptCount], T1.[aspnet_Membership.FailedPasswordAttemptWindowStart], T1.[");
            viewString.Append("aspnet_Membership.FailedPasswordAnswerAttemptCount], T1.[aspnet_Membership.Faile");
            viewString.Append("dPasswordAnswerAttemptWindowStart], T1.[aspnet_Membership.Comment], T1.[aspnet_M");
            viewString.Append("embership.PasswordValidity])\r\n    FROM (\r\n        SELECT \r\n            T.Applica");
            viewString.Append("tionId AS [aspnet_Membership.ApplicationId], \r\n            T.UserId AS [aspnet_M");
            viewString.Append("embership.UserId], \r\n            T.Password AS [aspnet_Membership.Password], \r\n ");
            viewString.Append("           T.PasswordFormat AS [aspnet_Membership.PasswordFormat], \r\n           ");
            viewString.Append(" T.PasswordSalt AS [aspnet_Membership.PasswordSalt], \r\n            T.MobilePIN A");
            viewString.Append("S [aspnet_Membership.MobilePIN], \r\n            T.Email AS [aspnet_Membership.Ema");
            viewString.Append("il], \r\n            T.LoweredEmail AS [aspnet_Membership.LoweredEmail], \r\n       ");
            viewString.Append("     T.PasswordQuestion AS [aspnet_Membership.PasswordQuestion], \r\n            T");
            viewString.Append(".PasswordAnswer AS [aspnet_Membership.PasswordAnswer], \r\n            T.IsApprove");
            viewString.Append("d AS [aspnet_Membership.IsApproved], \r\n            T.IsLockedOut AS [aspnet_Memb");
            viewString.Append("ership.IsLockedOut], \r\n            T.CreateDate AS [aspnet_Membership.CreateDate");
            viewString.Append("], \r\n            T.LastLoginDate AS [aspnet_Membership.LastLoginDate], \r\n       ");
            viewString.Append("     T.LastPasswordChangedDate AS [aspnet_Membership.LastPasswordChangedDate], \r");
            viewString.Append("\n            T.LastLockoutDate AS [aspnet_Membership.LastLockoutDate], \r\n       ");
            viewString.Append("     T.FailedPasswordAttemptCount AS [aspnet_Membership.FailedPasswordAttemptCou");
            viewString.Append("nt], \r\n            T.FailedPasswordAttemptWindowStart AS [aspnet_Membership.Fail");
            viewString.Append("edPasswordAttemptWindowStart], \r\n            T.FailedPasswordAnswerAttemptCount ");
            viewString.Append("AS [aspnet_Membership.FailedPasswordAnswerAttemptCount], \r\n            T.FailedP");
            viewString.Append("asswordAnswerAttemptWindowStart AS [aspnet_Membership.FailedPasswordAnswerAttemp");
            viewString.Append("tWindowStart], \r\n            T.Comment AS [aspnet_Membership.Comment], \r\n       ");
            viewString.Append("     T.PasswordValidity AS [aspnet_Membership.PasswordValidity], \r\n            T");
            viewString.Append("rue AS _from0\r\n        FROM CentralDBModelStoreContainer.aspnet_Membership AS T\r");
            viewString.Append("\n    ) AS T1");
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.aspnet_Membership", viewString.ToString());
        }
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for CentralDBModelStoreContainer.tblDeviceFCMToken
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView301()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CentralDBModelStoreContainer.tblDeviceFCMToken", @"
    SELECT VALUE -- Constructing tblDeviceFCMToken
        [CentralDBModel.Store.tblDeviceFCMToken](T1.tblDeviceFCMToken_ID, T1.[tblDeviceFCMToken.Device_ID], T1.tblDeviceFCMToken_FCMToken)
    FROM (
        SELECT 
            T.ID AS tblDeviceFCMToken_ID, 
            T.Device_ID AS [tblDeviceFCMToken.Device_ID], 
            T.FCMToken AS tblDeviceFCMToken_FCMToken, 
            True AS _from0
        FROM Entities.tblDeviceFCMToken AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for Entities.tblDeviceFCMToken
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView302()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("Entities.tblDeviceFCMToken", @"
    SELECT VALUE -- Constructing tblDeviceFCMToken
        [CentralDBModel.tblDeviceFCMToken](T1.tblDeviceFCMToken_ID, T1.[tblDeviceFCMToken.Device_ID], T1.tblDeviceFCMToken_FCMToken)
    FROM (
        SELECT 
            T.ID AS tblDeviceFCMToken_ID, 
            T.Device_ID AS [tblDeviceFCMToken.Device_ID], 
            T.FCMToken AS tblDeviceFCMToken_FCMToken, 
            True AS _from0
        FROM CentralDBModelStoreContainer.tblDeviceFCMToken AS T
    ) AS T1");
        }
    }
}
