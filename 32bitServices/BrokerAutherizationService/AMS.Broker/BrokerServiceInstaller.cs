...
namespace AMS.Broker.AutherizationService
{
    ...
    public class BrokerServiceInstaller : Installer
    {
        public BrokerServiceInstaller()
        {
            ...
            serviceInstaller.DisplayName = "2020BrokerAutherizationService";
            serviceInstaller.StartType = ServiceStartMode.Automatic;
            serviceInstaller.Description = "I3OP Server,Its a main server for 2020 platform.";


            //must be the same as what was set in Program's constructor
            serviceInstaller.ServiceName = "2020BrokerAutherizationService";
        ...
        public override void Install(System.Collections.IDictionary stateSaver)
        {
            ...
            // auto-start
            ServiceController controller = new ServiceController("2020BrokerAutherizationService");
            try
            {
                controller.Start();
            }
