...
namespace AMS.Broker.AutherizationService.DataStore
{
    ...
    {
        public CentralDBEntities() : base(Storage.CentralDBEntitiesString)//"name=CentralDBEntities") //amit 18052017
        {
        }
        ...
        public DbSet<tblDeviceFCMToken> tblDeviceFCMToken { get; set; }
        ...
        public virtual int SPInsertAccount(string accountName, string accountnumber, string email, string addressName, string addressline, string city, string state, string country, Nullable<int> postalCode, Nullable<double> latitude, Nullable<double> longitude, string title, string firstName, string lastName, string contactTelephone, string emailAddress, string mobileNumber, string faxNumber, string location, ObjectParameter result)
        {
