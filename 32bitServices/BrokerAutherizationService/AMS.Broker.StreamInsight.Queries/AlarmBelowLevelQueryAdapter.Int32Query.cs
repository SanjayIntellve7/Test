...
namespace AMS.Broker.AutherizationService.StreamInsight.Queries
{
    ...
    public class AlarmBelowLevelQueryAdapterInt32Query : StreamingQueryProvider<AlarmBelowLevelQueryAdapterInt32Config>
    {
                ...
                Application cepApplication)
        {
            ...
            var query =
                ...
                where item.Value < Configuration.AlaramLevel && item.ItemId == refItem.StreamInsightId
                select new
                {
                    Name = item.ItemId,
    ...
    /// </summary>
    public class AlarmBelowLevelQueryAdapterInt32Config : QueryProviderConfigurationBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleQueryAdapterQueryProviderConfig"/> class.
        /// </summary>
        public AlarmBelowLevelQueryAdapterInt32Config() : base() { }
        ...
        public override void Initialize(PlugInConfigurationElement configurationElement)
        {
            ...
            AlaramLevel = configurationElement.GetSettingAsInt("AlaramLevel", 100, true);
        }
        ...
        public Int32 AlaramLevel { get; set; }
    }
}