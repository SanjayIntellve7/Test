...
function draWAlertBifurcationWithFilter(filter, chartType, TypeCSV) {

    $.ajax({
        type: "GET",
        url: "https://localhost:44393/api/Dashboard/GetAlertBifurcationWithFilter?Datafilter=" + filter + "&TypeFilter=" + TypeCSV,
        contentType: "application/json",
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(jqXHR + "-" + textStatus + "-" + errorThrown); $("#AlertBifurcationBySourceChart-loading-image").hide();
            alert("Something went wrong!");
        ...
        success: function (result) {
            ...
            chartdata.push({ type: chartType, indexLabelPlacement: "outside", indexLabel: indexLabel_type, toolTipContent: toolTipContent_type, dataPoints: DataPointsCollection.first, legendText: DataPointsCollection.first.name });
            if (DataPointsCollection.second != null)
                chartdata.push({ type: chartType, indexLabelPlacement: "outside", indexLabel: indexLabel_type, toolTipContent: toolTipContent_type, dataPoints: DataPointsCollection.second, legendText: DataPointsCollection.second.name });
...
function draWAcknowledgeSentWithFilter(filter, chartType, TypeCSV) {

    $.ajax({
        type: "GET",
        url: "https://localhost:44393/api/Dashboard/GetAlertSentAcknowledgeWithFilter?Datafilter=" + filter + "&TypeFilter=" + TypeCSV,
        contentType: "application/json",
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(jqXHR + "-" + textStatus + "-" + errorThrown); $("#AlertAcknowledgeClosingChart-loading-image").hide();
            alert("Something went wrong!");
        },
        success: function (result) {
            $("#AcknowledgeSentChart-loading-image").hide();
            var DataPointsCollection = $.parseJSON(result);
            let chartdata = [];
            ...
            var chart = new CanvasJS.Chart("AcknowledgeSentChartContainer",
                {
                    colorSet: "shades",
                    theme: "light1", // "light1", "light2", "dark1", "dark2"
                    animationEnabled: true,
            ...
            $("#AcknowledgeSentChart-loading-image").show();
        }
    });
}

function draWAcknowledgeClosingWithFilter(filter, chartType, TypeCSV) {

    $.ajax({
        type: "GET",
        url: "https://localhost:44393/api/Dashboard/GetAlertAcknowledgeClosingWithFilter?Datafilter=" + filter + "&TypeFilter=" + TypeCSV,
        contentType: "application/json",
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(jqXHR + "-" + textStatus + "-" + errorThrown); $("#AcknowledgeClosingChart-loading-image").hide();
            alert("Something went wrong!");
        },
        success: function (result) {
            $("#AcknowledgeClosingChart-loading-image").hide();
            var DataPointsCollection = $.parseJSON(result);
            let chartdata = [];
            ...
            var chart = new CanvasJS.Chart("AcknowledgeClosingChartContainer",
                {
                    colorSet: "shades",
                    theme: "light1", // "light1", "light2", "dark1", "dark2"
                    animationEnabled: true,
            ...
            $("#AcknowledgeClosingChart-loading-image").show();
        }
    });
}

function draWClosingSentWithFilter(filter, chartType, TypeCSV) {

    $.ajax({
        type: "GET",
        url: "https://localhost:44393/api/Dashboard/GetAlertSentClosingWithFilter?Datafilter=" + filter + "&TypeFilter=" + TypeCSV,
        contentType: "application/json",
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(jqXHR + "-" + textStatus + "-" + errorThrown); $("#AlertClosingSentChart-loading-image").hide();
            alert("Something went wrong!");
        },
        success: function (result) {
            $("#ClosingSentChart-loading-image").hide();
            var DataPointsCollection = $.parseJSON(result);
            let chartdata = [];
            ...
            var chart = new CanvasJS.Chart("ClosingSentChartContainer",
                {
                    colorSet: "shades",
                    theme: "light1", // "light1", "light2", "dark1", "dark2"
                    animationEnabled: true,
            ...
            $("#ClosingSentChart-loading-image").show();
        }
    });
}
...
function drawChartWithFilter(From, To, chartType, DeviceTypesSelected, BranchIdsSelected, OperatorsSelected) {

    let data = { "from": From, "to": To, "deviceTypes": DeviceTypesSelected, "branchIds": BranchIdsSelected, "operators": OperatorsSelected };
     
    $.ajax({
        type: "POST",
        url: "https://localhost:44393/api/Charts/GetFrequentMostAlertGeneratingBranchesWithFilter",
        contentType: "application/json",
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            ...
            let indexLabel_type, toolTipContent_type;
            if (chartType == "pie") { indexLabel_type = "#percent%"; toolTipContent_type = "{y} (#percent%)"; }
            else { indexLabel_type = "{y}"; toolTipContent_type = "<strong>{y}</strong>"; }
